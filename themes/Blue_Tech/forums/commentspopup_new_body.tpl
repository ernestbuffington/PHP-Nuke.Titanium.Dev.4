...
<table width="80%" cellpadding="5" cellspacing="1" border="0" class="forumline" align="center">
  <tr>
        ...
        <tr>
                <td colspan='2'align='center' class='row2'><span class="gensmall">{L_COMMENTS_CHAMPION}</span></td>
        </tr>
...
<form action="{S_ACTION}" method="post" name="post" >
        ...
        <tr>
                <td colspan='2'align='center' class='row2'><span class="gensmall">{L_NO_COMMENT}</span></td>
        </tr>
</table>
<br />