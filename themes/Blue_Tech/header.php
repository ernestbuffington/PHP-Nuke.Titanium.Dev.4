...
$scrollmsg .= ' Ezekiel 25,17. "The path of the righteous man is beset of all sides by the iniquities of the selfish and the tyranny of evil men. Blessed is he who, in the name of the charity and goodwill, shepherds the weak through the valley of darkness, for he is truly his brotherâ€™s keeper and the finder of lost children. And I will strike down upon thee with great vengeance and furious anger those who attempt to poison and destroy my brothers. And you will know my name is the Lord when I lay my vengeance upon thee.â€ ::: ';
...
$date .= '::: <span style=color:orange> QUOTE OF THE DAY 📖 "If you don\'t want to do something, you\'ll find an excuse. If you really do, you\'ll find a way. 💪 Open-Source for Life ❤ Tomas Votruba"</span> ::: Today is <span style="color:'.$textcolor2.'">'.$serverdate.'</span>';
...
echo '<div align="center">';
	echo '<table border="1" cellpadding="0" cellspacing="0" width="100%" height="189" bgcolor="#0b151f">';
		echo '<tr>';
			# network ad rigth left of page
			echo '<td width="33.3%">';
			echo '<div align="left">&nbsp;&nbsp;&nbsp;'.ads(0).'';
			echo '<div align="left" class="marquee_one">&nbsp;&nbsp;&nbsp;<font size="2" color="'.$marquee_color.'"><strong>'.$marquee_one.'</strong></font></div>'."\n\n";
			echo '</td>';
			
			# logos
			echo '<td width="33.3%">';
			echo '<div align="center" class="logo" id="logo"><svg width="64" viewBox="0 0 128 128">
...
echo '<div align="center"><strong><h2><spam>'.$eighty_six_it.'</spam></h2></strong></div>';
echo '</div>';
			echo '</td>';
			
			# network ad rigth side of page
			echo '<td width="33.3%">';
			echo '<div align="right">'.network_ads(0).'&nbsp;&nbsp;&nbsp;</div>';
			echo '<div class="marquee_two"><font size="2" color="'.$marquee_color.'"><strong>'.$marquee_two.'</strong></font></div>'."\n\n";
			echo '</td>';
		echo '</tr>';
	echo '</table>';
echo '</div>';
