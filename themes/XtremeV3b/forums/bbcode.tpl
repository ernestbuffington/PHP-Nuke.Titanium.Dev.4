...
<strong>Protected Message: - Thank you for replying...</strong>
<blockquote class="unprotected">
{HTEXTE}
</blockquote>
<span class="postbody">
<!-- END show -->
...
<strong>Protected Message:</strong>
<blockquote class="protected">
...
<!-- BEGIN code_open --></span><div class="codebox"><p>Code: [ <a href="#" class="code_selection">Select all</a> ]</p><pre><code><!-- END code_open -->

<!-- BEGIN code_close --></code></pre></div><span class="postbody"><!-- END code_close -->

<!-- BEGIN php_open --></span><div class="codebox phpcodebox"><p>PHP:&nbsp;&nbsp;[ <a href="#" class="code_selection code_select">Select all</a> ]</p><pre><code><!-- END php_open -->

<!-- BEGIN php_close --></code></pre></div><span class="postbody"><!-- END php_close -->
...
<!-- BEGIN highlight_open --><span style="background-color: {COLOR};"><!-- END highlight_open -->
...
<!-- BEGIN spoil_open --><div align="center"><div class="spoiltitle"><strong>{L_BBCODEBOX_HIDDEN}:</strong>&nbsp;
        <input class="spoilbtn" type="button" value="{L_BBCODEBOX_VIEW}" style="cursor: pointer" onClick="javascript:if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.innerText = ''; this.value = '{L_BBCODEBOX_HIDE}'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = ''; this.value = '{L_BBCODEBOX_VIEW}'; }" onfocus="this.blur();"></div><div class="spoildiv"><div style="display: none;"><!-- END spoil_open -->
<!-- BEGIN spoil_close --></div></div></div><span class="postbody"><!-- END spoil_close -->

<!-- BEGIN align_open --><div style="text-align:{ALIGN}; display: block;"><!-- END align_open -->
<!-- BEGIN align_close --></div><!-- END align_close -->

<!-- BEGIN center_open --><div style="text-align:center; display: block;"><!-- END center_open -->
<!-- BEGIN center_close --></div><!-- END center_close -->

<!-- BEGIN left_open --><div style="text-align:left; display: block;"><!-- END left_open -->
<!-- BEGIN left_close --></div><!-- END left_close -->

<!-- BEGIN right_open --><div style="text-align:right; display: block;"><!-- END right_open -->
<!-- BEGIN right_close --></div><!-- END right_close -->

<!-- BEGIN justify_open --><div style="text-align:justify; display: block;"><!-- END justify_open -->
...
<!-- BEGIN facebook --><iframe src="https://www.facebook.com/video/embed?video_id={FACEBOOK}" width="{FACEBOOK_WIDTH}" height="{FACEBOOK_HEIGHT}" frameborder="0"></iframe><!-- END facebook -->
