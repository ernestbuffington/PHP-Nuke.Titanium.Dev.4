...
global $locked_width, $screen_res, $sitename, $slogan, $name, $banners, $db, $user_prefix, $prefix, $admin_file, $userinfo, $ThemeInfo, $theme_name;
...
{
$scrollmsg .= "<img border=\"0\" align=\"absmiddle\" height=\"16\" src=\"https://hub.86it.us/images/browsers/edge-beta@1x.png\" alt=\"Browser\" title=\"Browser\"> <strong>Thanks for using Microsoft Edge (64-bit), Looks like Microsoft finally pulled their head out of their ass!</strong>";
}
else 
...
{
$scrollmsg .= "<img border=\"0\" align=\"absmiddle\" height=\"16\" src=\"https://hub.86it.us/images/browsers/edge-beta@1x.png\" alt=\"Browser\" title=\"Browser\"> <strong>Thanks for using Microsoft Edge Beta (64-bit), Looks like Microsoft finally pulled their head out of their ass!</strong>";
}
else
if($titanium_browser->getBrowser() == Browser::BROWSER_CHROME && $titanium_browser->getVersion() == '70.0.3538.102') // MicroSoft Edge (x64bit) 
{
$scrollmsg .= "<img border=\"0\" align=\"absmiddle\" height=\"16\" src=\"https://hub.86it.us/images/browsers/edge.png\" alt=\"\" title=\"\"> <strong>Thanks for using Microsoft Edge (64-bit)</strong>";
}
else
...
{
$scrollmsg .= "<img border=\"0\" align=\"absmiddle\" height=\"15\" src=\"https://hub.86it.us/images/browsers/current-channel-logo@1x.png\" alt=\"Browser\" title=\"Browser\"> <strong>Thanks for using Chrome Canary (64-bit) We are glad you keep up with the times on a nightly basis!</strong>";
}
else
...
{
$scrollmsg .= "<img style=\"vertical-align:absmiddle\" border=\"0\" height=\"10\"  src=\"https://hub.86it.us/images/browsers/logo-maxthon.png\" alt=\"Browser\" title=\"Browser\"> <strong>Thanks for using Maxthon</strong> ";
...
$moreuser_info = '::: Software developers like to solve problems. And online communities are a perfect place to let them help each other. ';
$moreuser_info = '::: We really appreciate it when you take the time to login and look around. We spent a lot of time building this network and nothing makes us more happy than when our visitors truly enjoy their visit! ';
		
if ($username === 'TheWolf')
$moreuser_info .= '::: Don\'t be such a Stranger! Thanks for killing Nicholas Oneil Ryder, that guys was truly a piece of shit!';

if ($username === 'EOL') 
$moreuser_info .= '::: Don\'t be such a Stranger!';

if ($username === 'AlphaClient')
$moreuser_info .= '::: We have detected that you are using a cell phone, one moment please whie I verify your identity!                                                                                   looking up your phone number now................................................................................Brandon, Florida 813-244-9921                                                                                                                                                                                                                                 We are sorry but this phone number does not appear to be registered to you DISCONNECTING NOW!                                                                                                                                                                                                                                 Just Kidding ROFLMAO!';
...
if ($username === _ANONYMOUS)
$bullshit = $moreuser_info.' ::: Your Monitor Resolution is <font color="#f48024">'.$screen_res.'</font> ::: '.$newmessages.'';
else
$bullshit = 'Woot! I can see <strong><font color="yellow"><span class="blink-one">'.$username.'</span></font></strong> is in the house! It\'s quite awesome to see you my friend! We are so glad you could make it back over to visit... We know with your super tight busy schedule and all, it most certainly must have been quite a task! ::: '.$newmessages.' ::: Your current Monitor Resolution is <font color="#f48024">'.$screen_res.'</font> '.$moreuser_info.' ::: Your current browser version is <font color="#f48024">'.$titanium_browser->getVersion().'</font> ::: '.$scrollmsg.'</div>';
...
//echo "\n\n<!-- START marquee -->\n\n";
//echo '<div class="marquee_one"><font size="2"><strong>'.$bullshit,'</strong></font></div>'."\n\n";
//echo '<div class="marquee_two"><font size="2"><strong>'.$bullshit2,'</strong></font></div>'."\n\n";
//echo "<!-- END marquee -->\n\n";

#-----------------#
# RD Scripts v1.0 #
#-----------------#
addJSToBody(carbinfiber_red_flames_js_dir.'menu.min.js');
...
echo '<!-- HEADER START -->'; # set background here in themes/CarbonFiber/css/maintable.php
...
# left side table 2
echo '<td background="themes/'.$theme_name.'/header/left_side.gif"><img name="leftside" src="themes/'
.$theme_name.'/header/invisible_pixel.gif" width="1" height="1" border="0" alt=""></td>';
...
echo '<div align="center">';
	echo '<table border="1" cellpadding="0" cellspacing="0" width="100%" height="189" bgcolor="#666666">';
		echo '<tr>';
			# network ad rigth left of page
			echo '<td width="33.3%">';
			echo '<div align="left">&nbsp;&nbsp;&nbsp;'.ads(0).'';
			echo '<div align="left" class="marquee_one">&nbsp;&nbsp;&nbsp;<font size="2"><strong>'.$bullshit,'</strong></font></div>'."\n\n";
			echo '</td>';
...
echo '</div>';
	...
	echo '</table>';
echo '</div>';
echo '<div class="flex-item" style="width: 100%; height: 29px; background-image: url('.carbinfiber_red_flames_hdr_images.'HDRnav_Bg_Stretch.png)">';  #
include(carbinfiber_red_flames_theme_dir.'HDRnavi.php');                                                                                              #
echo '</div>';                                                                                                                                        #
...
echo '<td background="themes/'.$theme_name.'/header/right_side.png" width="38"></td>';
...
echo '<td height="62" background="themes/'.$theme_name.'/header/bottom_middle.png" align="center" valign="top"></td>';
