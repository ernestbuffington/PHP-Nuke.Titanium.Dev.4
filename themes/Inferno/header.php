...
//echo "<img src=\"themes/".$theme_name."/images/invisible_pixel.gif\" alt=\"\" width=\"1\" height=\"9\" border=\"0\" />";

echo '<div class="fullscreen-bg">';
echo '<video loop autoplay poster="themes/'.$theme_name.'/backgrounds/1920x1080_black_default.png" class="fullscreen-bg__video">';
echo '<source src="themes/'.$theme_name.'/video/2gb.mp4" type="video/mp4">';
echo '</video>';
echo '</div>';
...
echo '<div class="banner_left">'.ads(0).'</div>'; 
...
# right header ad banner for all network advertising
echo '<div class="banner_right">'.network_ads(0).'</div>'; 
# logo end
...
//echo '<div align="center" id="text"><img name="tbm" src="themes/'.$theme_name.'/header/invisible_pixel.gif" width="1" height="8" border="0" alt=""></div>';
# MENU SYSTEM
#######################################################################################################################################################
...
echo "\n\n<!-- START marquee -->\n\n";
echo '<div class="marquee_one"><font color="#ffc62a" size="2"><strong>'.$marquee_one,'</strong></font></div>'."\n\n";
echo '<div class="marquee_two"><font color="#ffc62a" size="2"><strong>'.$marquee_two,'</strong></font></div>'."\n\n";
echo "<!-- END marquee -->\n\n";
