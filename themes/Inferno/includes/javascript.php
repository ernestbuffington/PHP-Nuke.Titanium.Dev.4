...
<div class="modal fade" id="myCopyRight" tabindex="-1" role="dialog" aria-labelledby="CenterTitle" aria-hidden="true">
    ...
    <div class="modal-content modal-popout-bg">
      ...
      <div class="modal-header">
        ...
        <font size="2" class="display-1" color="#000000"><i class="bi bi-arrow-right-square-fill"></i> Theme: <?=THEME?>
                 ...
                 <br /><i class="bi bi-arrow-right-square-fill"></i> Intended Use: 4 Sale - Price $500.00
                 <br /><i class="bi bi-arrow-right-square-fill"></i> Designed For: PHP-Nuke Titanium Dev 4
  ...
  This is a very versatile theme layout and can be configured in many different ways. We will help you in any possible way provided you're a network member.</p>
  <br />
  </font></strong>
