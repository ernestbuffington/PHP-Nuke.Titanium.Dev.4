...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <tr> 
    ...
    <td align="left" valign="middle" width="100%">&nbsp;&nbsp;&nbsp;<a href="{U_INDEX}">{L_INDEX}</a><!-- IF PARENT_FORUM --> -> <a href="{U_VIEW_PARENT_FORUM}">{PARENT_FORUM_NAME}</a> <!-- ENDIF --> -> <a href="{U_VIEW_FORUM}">{FORUM_NAME}</a></td>
