...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
        <td class="forumline2" colspan="{ARCADE_COL}" nowrap="nowrap" align="center"><span class="cattitle">{CATTITLE}</span></td>
  </tr>
  <!-- END use_category_mod -->
  <tr> 
        <td class="forumline2" height="28" align="center" colspan="2"><span class="cattitle">{L_GAME}</span></td>
        <td class="forumline2" nowrap="nowrap" align="center"><span class="cattitle">{L_HIGHSCORE}</span></td>
        <td class="forumline2" nowrap="nowrap" align="center"><span class="cattitle">{L_YOURSCORE}</span></td>
        <td class="forumline2" colspan="{ARCADE_COL1}" nowrap="nowrap" align="center"><span class="cattitle">{L_DESC}</span></td>
  </tr>
<!-- BEGIN favrow -->

<tr>
        <td class="forumline2" colspan="6"><span class="cattitle">{FAV}</span></td>
</tr>
