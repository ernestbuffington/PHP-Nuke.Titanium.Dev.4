...
print '<td valign="top" align="center" style="background: repeat-x; background-image: url('.HTTPS.'themes/'.$theme_name.'/images/BLOG/top_middle_piece.png);"><br><strong>Portal Blog</stron></td>'."\n";
...
print '<table style="background-color: none; height:100%; width:99%;" class="theme_index forumline" align="center" border="5" cellpadding="15" cellspacing="20" dir="ltr" id="theme_index">';
print '<tbody>';
print '<tr>';
print '<td>';
...
echo '<div align="center" id="text"><h1><font color="'.$font_colorA.'" size="6"><strong>'.$title.'</strong></font></h1>';
print '</div>';
