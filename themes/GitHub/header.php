...
print '<td width="100%">'."\n";
print '<table style="background-color: none; height:100%; width:100%;" class="theme_header forumline" align="center" border="0" cellpadding="0" cellspacing="0" dir="ltr" id="theme_header">';
print '<tr>'."\n";
print '<td width="100%">'."\n";
...
echo '<tr>';
echo '<td align="left" width="25%" valign="bottom" height="20"><div class="marquee_one"><font size="2"><strong>'.$marquee_one.'</strong></font></div></td>';
echo '<td align="right" width="25%" valign="bottom" height="20"><div class="marquee_two"><font size="2"><strong>'.$marquee_two.'</strong></font></div></td>';
echo '</tr>';
