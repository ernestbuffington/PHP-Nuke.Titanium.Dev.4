...
print '<td width="100%">'."\n";
print '<table style="background-color: none; height:100%; width:99%;" class="theme_index forumline" align="center" border="5" cellpadding="15" cellspacing="20" dir="ltr" id="theme_footer">';
