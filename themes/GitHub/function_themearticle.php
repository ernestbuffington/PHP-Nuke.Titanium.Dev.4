...
print '<td valign="top" align="center" style="background: repeat-x; background-image: url('.HTTPS.'themes/'.$theme_name.'/images/BLOG/top_middle_piece.png);"><br /><strong>Portal Blog</strong></td>'."\n";
...
print '<table style="background-color: none; height:100%; width:99%;" class="theme_index forumline" align="center" border="5" cellpadding="15" cellspacing="20" dir="ltr" id="theme_article">';
print '<tbody>';
print '<tr>';
print '<td>';
...
echo '<div align="center" id="text"><h1><font color="'.$font_colorA.'" size="6"><strong>'.$topictext.'</strong></font><br/></h1>';
print '</div>';

print '<div align="center" style="padding-top:1px;"><h2><font color="'.$font_colorA.'" size="4"><strong>'.$title.'</strong></font></h2>';
print '</div>';
