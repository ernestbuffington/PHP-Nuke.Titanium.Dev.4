...
# This stays no matter what START ------------------------------------------------------------------------------------------------------------------------------
echo "<!-- CONTENT START -->\n\n\n\n\n";
print '<table style="cellSpacing="0" cellPadding="8" width="100%" border="5" style="border-collapse: collapse" bordercolor="#111111">'."\n";
print '<tr>'."\n";
print '<td width="100%">'."\n";
print '<div align="center">';

print '<table style="background-color: none; height:100%; width:99%;" class="theme_index forumline" align="center" border="5" cellpadding="15" cellspacing="20" dir="ltr" id="theme_centerbox">';
