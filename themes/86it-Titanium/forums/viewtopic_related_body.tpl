...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="forumline">
	...
	<tr>
		...
		<td class="fixcell" align="center" valign="middle" nowrap="nowrap"><span class="postdetails">{topicrow.LAST_POST_TIME}<br />{topicrow.LAST_POST_AUTHOR} {topicrow.LAST_POST_IMG}</span></td>
	</tr>
	<!-- END topicrow -->
	<tr>
