 ...
 <table width="100%" cellpadding="2" cellspacing="3" border="0">
    ...
    <tr>
        <td width="100%">
          ...
          <tr>
            <td class="row2" width="25%"><p align="center"><span class="cattitle">{L_TOP}</span></p></td>
            <td class="row2" width="60%"><p align="center"><span class="cattitle">{L_RECENT}</span></p></td>
            <td class="row2" width="15%"><p align="center"><span class="cattitle">{L_USER_INFO}</span></p></td>
          </tr>
                ...
                <td valign=top  width="100%">
                  <table cellspacing=0 cellpadding=0 width="100%" border=0>
                    <tbody>
                                    <!-- BEGIN bestscore2 -->
                            <tr>
                              <td class="{arcaderow2.bestscore2.CLASS}"  align=left width="85%" valign="top"><p><span class=smallfont><li></span><span class="gensmall">{arcaderow2.bestscore2.L_HEADING_CHAMP}</span></p></td>
        ...
        <td class="row1" align="center" valign="center" width="15%" rowspan="2" height="93"><p align="center">
                        ...
                        <span class="gensmall"><br /><img src="themes/86it-Titanium/forums/images/couronne.png"><br />{ARCADE_VICTOIRES}</span><br />
                ...
                <td valign=top  width="100%" valign="top">
                  <table valign=top cellspacing=1 cellpadding=2 width="100%" border=0>
                    <tbody>
                             <!-- BEGIN score3 -->
                    <tr>
                      <td class="alt1" valign=top align=left width="85%"><p><span class="gensmall"><span class=smallfont><li></span><span class="gensmall">{arcaderow3.score3.L_LAST_SCORE}</span></p></td>
                    </tr>
                           <!-- END score3 --> 
                           </tbody>
                         </table>
...
<td align='center' class='row1'><br /><strong>{L_SEARCH_ARCADE}:</strong> <select name="searchin"><option selected value="name">{L_GAME_NAME}</option><option value="desc">{L_GAME_DESCRIPTION}</option></select>&nbsp;<input type="text" name="srchstring" size="35" title="{L_SEARCH_DESCRIPTION}"><input type="submit" value="Search"><br /><br />
<a href="modules.php?name=Forums&amp;file=arcade_search&amp;x=1"><strong>[ {L_NO_PLAY} ]</strong></a><a href="modules.php?name=Forums&amp;file=arcade_search&amp;x=2"><strong>[ {L_GAMES_NEWEST} ]</strong></a><br /><br /></td>
</form>
</tr>
</table>