...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <tr>
        ...
        <th class="fixcell" width="100" align="center" nowrap="nowrap">&nbsp;{L_FORUM}&nbsp;</th>
        <th class="fixcell" width="100" align="center" nowrap="nowrap">&nbsp;{L_AUTHOR}&nbsp;</th>
        <th class="fixcell" width="50" align="center" nowrap="nowrap">&nbsp;{L_REPLIES}&nbsp;</th>
        <th class="fixcell" align="center" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
    </tr>
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundImage='url(../themes/86it-Titanium/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Titanium/images/backgrounds/b.png)'"><span class="genmed"><a href="{news.TOPIC_LINK}" class="genmed">{news.TOPIC_TITLE}</a></span></td>
    ...
    <tr> 
        <td class="spaceRow" colspan="6" height="1"><img src="themes/86it-Titanium/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
    </tr>
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundImage='url(../themes/86it-Titanium/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Titanium/images/backgrounds/b.png)'"><span class="genmed"><a href="{recent.TOPIC_LINK}" class="genmed">{recent.TOPIC_TITLE}</a></span></td>
