...
global $bgcolor4, $body_color;
# top of awesome table
print '<table bgcolor="'.$body_color.'" class="blockz" cellSpacing="0" cellPadding="0" border="0" width="100%">'."\n";
...
print '<tr>'."\n";
print '<td width="100%" bgcolor="'.$body_color.'">'."\n";
