...
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Markup Language: HTML 4.01 Transitional'."\n";
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Copyright: <i class="far fa-copyright"></i> DarkForge Graphics'."\n";
...
echo '<br /><i class="devicon-css3-plain colored"></i> 3 Scrolling Marquees'."\n";
