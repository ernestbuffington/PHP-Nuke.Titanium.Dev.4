...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
    ...
    <tr> 
        <td class="row1" width="22%"><span class="gen"><strong>{L_RECIPIENT}</strong></span></td>
        <td class="row2" width="78%"><span class="gen"><strong>{USERNAME}</strong></span> </td>
    </tr>
    <tr> 
    ...
    <tr> 
        <td class="row1" valign="top"><span class="gen"><strong>{L_MESSAGE_BODY}</strong></span><br /><span class="gensmall">{L_MESSAGE_BODY_DESC}</span></td>
    ...
    <tr> 
        <td class="row1" valign="top"><span class="gen"><strong>{L_OPTIONS}</strong></span></td>
