...
echo '<h1 class="modal-title" id="CenterTitle">'."\n";
echo '<font size="2" class="display-1" color="#000000"><i class="bi bi-arrow-right-square-fill"></i> Theme Name: '.THEME.''."\n";
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Markup Language: XHTML'."\n";
...
echo '<h1 class="display-1"><font size="4" color="black"><i class="bi bi-sliders"></i> Theme Overview</font></h1> '."\n";
echo '<div class="lead">'."\n";
echo ''.THEME_OVERVIEW.''."\n";
echo '</div>'."\n";
echo '<div class="card-header">'."\n";
echo '<font color="#000000"><strong>Features</strong></font>'."\n";
echo '</div>'."\n";
