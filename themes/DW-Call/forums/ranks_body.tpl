...
<tr>
    ...
    <td valign="top" width="50%">
        ...
        <tr>
            <th class="thHead" height="25" valign="middle" colspan="3" style="padding-top: 30px;">{L_RANKS}</th>
        </tr>
        <tr>
    ...
    <td valign="top" width="50%">
        <table border="0" cellpadding="4" cellspacing="1" class="forumline" width="100%">
        <tr>
            <th class="thHead" height="25" valign="middle" colspan="2" style="padding-top: 30px;">{L_SPECIAL_RANKS}</th>
        </tr>
        <tr>
        ...
        <!-- BEGIN spe_ranks -->
        <tr>
            <td class="row1" align="center" nowrap="nowrap" style="padding-top: 15px;">
                <span class="gen">{spe_ranks.RANK_TITLE}<br />{spe_ranks.RANK_IMAGE}</span>
            </td>
            <!-- BEGIN userlist -->
            <td class="row2" valign="top" style="padding: 5px;">
                <span class="gensmall">{spe_ranks.userlist.USERS_LIST}</span>
            </td>
            <!-- END userlist -->
            <!-- BEGIN no_userlist -->
            <td class="row2" align="center" valign="top" style="padding: 5px;">
