...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
    <th class="thHead" colspan="2" height="25" nowrap="nowrap" style="padding-top: 30px;">{L_VIEWING_PROFILE}</th>
  </tr>
  <tr> 
  ...
  <tr> 
    <td class="row1" height="6" valign="middle" align="center" style="padding: 20px 0px 50px 0px;">{AVATAR_IMG}<br /><span class="postdetails">{POSTER_RANK}</span></td>
    <td class="row1" rowspan="3" valign="top" style="padding: 30px 15px 15px 15px;"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
...
<!-- END show_groups -->        
  ...
  <tr> 
    <td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3" style="padding-top: 40px;">
        <tr> 
          <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_EMAIL_ADDRESS}:</span></td>
          <td class="row1" valign="middle" width="100%" style="padding: 0px 0px 5px 5px;"><strong><span class="gen">{EMAIL_IMG}</span></strong></td>
        </tr>
        <tr> 
          <td valign="middle" nowrap="nowrap" align="right"><span class="gen">{L_PM}:</span></td>
          <td class="row1" valign="middle" style="padding: 0px 0px 5px 5px;"><strong><span class="gen">{PM_IMG}</span></strong></td>
        </tr>
<tr> 
            <td valign="middle" nowrap="nowrap" align="right"><span class="gen">{L_ONLINE_STATUS}:</span></td>
            <td class="row1" valign="middle" style="padding: 3px 0px 0px 5px;"><span class="gen">{ONLINE_STATUS}</span></td>
        </tr>        
      </table>
    </td>
  </tr>
...
<!-- BEGIN user_sig -->
  ...
  <tr> 
    <td align="right"><span class="nav"><br /><br />{JUMPBOX}<br /><br /></span></td>
  </tr>
</table>
	</div>
		</div>
