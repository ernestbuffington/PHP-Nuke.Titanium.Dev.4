...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
    <td class="row1" align="center" valign="middle" style="width: 10%; padding: 10px 0px 10px 0px;">{L_SUBJECT}</td>
    <td class="row2" align="center" valign="middle" style="width: 90%; padding: 10px 0px 10px 0px;"><input type="text" name="subject" size="45" maxlength="60" style="width:98.8%; fpadding-left:7px; letter-spacing:1px;" tabindex="2" class="post" value="{SUBJECT}" /></td>
  </tr>
  <!-- BEGIN switch_icon_checkbox -->
  <tr>
    <td align="center" valign="middle" class="row1">{L_ICON_TITLE}</td>
    <td class="row2">
      <table width="100%" border="0" cellspacing="0" cellpadding="2" style="padding: 10px 0px 10px 10px;">
        <!-- BEGIN row -->
        <tr>
          <td nowrap="nowrap">
            <!-- BEGIN cell -->
  ...
  <tr> 
    <td class="row1" align="center" valign="middle">{L_OPTIONS}<span class="tooltip-html icon-sprite icon-info" title="{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}"></span></td>
    <td class="row2" style="padding: 15px 0px 10px 5px;"> 
  ...
  <!-- IF S_TYPE_TOGGLE -->
  <tr> 
    <td class="row1" align="center" style="padding: 15px 0px 10px 0px;">{L_TYPE_TOGGLE}</td>
    <td class="row2" style="padding-left: 5px;"> 
        {S_TYPE_TOGGLE}<br />
    </td>        
  </tr>
  <!-- ENDIF -->
  ...
  {POLLBOX} 
  <tr> 
    <td style="height:30px; text-align:center; padding: 50px 0px 10px 0px;" class="catBottom" colspan="2">
