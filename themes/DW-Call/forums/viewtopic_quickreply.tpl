...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <tr>
    <td class="row1" width="10%" align="center"><br />{L_SUBJECT}:</td>
    <td class="row2" width="90%"><br /><input type="text" tabindex="2" name="subject" maxlength="60" style="width:98.8%; padding-left:7px;" value="{SUBJECT}" /></td>
  </tr>
  <tr> 
  ...
  <tr>
    <td class="row1" valign="top" style="padding: 15px 0px 5px 0px;">{L_OPTIONS}</span><br /><hr />{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</td>
    <td class="row2" valign="top" style="padding: 10px 0px 5px 0px;">
  ...
  <tr> 
    <td class="catBottom" colspan="2" align="center" height="28" style="padding: 52px 0px 15px 0px;">
...
<table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
  <tr> 
    <td class="aright" valign="top"><br />{S_TIMEZONE}</td>
  </tr>
</table><br />
</form>
</div>