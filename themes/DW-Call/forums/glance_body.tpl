...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="0" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1"><span class="genmed" style="padding-left: 10px;"><a href="{news.TOPIC_LINK}" class="gen">{news.TOPIC_TITLE}</a></span></td>
        <td valign="middle" class="row2" nowrap="nowrap" align="center"><span class="genmed"><a href="{news.FORUM_LINK}" class="gen">{news.FORUM_TITLE}</a></span></td>
...
&nbsp;
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1"><span class="genmed" style="padding-left: 10px;"><a href="{recent.TOPIC_LINK}" class="content">{recent.TOPIC_TITLE}</a></span></td>
        <td valign="middle" class="row2" nowrap="nowrap" align="center"><span class="genmed"><a href="{recent.FORUM_LINK}" class="content">{recent.FORUM_TITLE}</a></span></td>
