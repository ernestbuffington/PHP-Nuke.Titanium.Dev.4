 ...
 */
require_once NUKE_ZEND_DIR.'Db/Profiler.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Db/Statement/Mysqli.php';
...
class Zend_Db_Adapter_Mysqli extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Db/Adapter/Mysqli/Exception.php';
