 ...
 */
require_once NUKE_ZEND_DIR.'Db/Adapter/Abstract.php';

/**
 * @see Zend_Db_Adapter_Abstract
 */
require_once NUKE_ZEND_DIR.'Db/Select.php';

/**
 * @see Zend_Db
 */
require_once NUKE_ZEND_DIR.'Db.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (!$db instanceof Zend_Db_Adapter_Abstract) {
            require_once NUKE_ZEND_DIR.'Db/Table/Exception.php';
    ...
    {
        require_once NUKE_ZEND_DIR.'Db/Table/Select.php';
    ...
    public static function getTableFromString($tableName, Zend_Db_Table_Abstract $referenceTable = null)
    {
        ...
        if (!class_exists($tableName)) {
            try {
                ...
                require_once NUKE_ZEND_DIR.'Db/Table/Row/Exception.php';
