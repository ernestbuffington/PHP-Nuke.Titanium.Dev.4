...
require_once NUKE_ZEND_DIR.'Search/Lucene/Search/Query/Preprocessing.php';
...
class Zend_Search_Lucene_Search_Query_Preprocessing_Term extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    public function rewrite(Zend_Search_Lucene_Interface $index)
    {
        if ($this->_field === null) {
            ...
            require_once NUKE_ZEND_DIR.'Search/Lucene.php';
            ...
            require_once NUKE_ZEND_DIR.'Search/Lucene/Search/Query/Preprocessing/Term.php';
