...
/** Zend_Oauth */
require_once NUKE_ZEND_DIR.'Oauth.php';

/** Zend_Uri */
require_once NUKE_ZEND_DIR.'Uri.php';

/** Zend_Oauth_Http_RequestToken */
require_once NUKE_ZEND_DIR.'Oauth/Http/RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once NUKE_ZEND_DIR.'Oauth/Http/UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once NUKE_ZEND_DIR.'Oauth/Http/AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once NUKE_ZEND_DIR.'Oauth/Token/AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once NUKE_ZEND_DIR.'Oauth/Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once NUKE_ZEND_DIR.'Oauth/Exception.php';
