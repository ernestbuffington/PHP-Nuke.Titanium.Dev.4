...
require_once NUKE_ZEND_DIR.'Service/Amazon/Sqs.php';
require_once NUKE_ZEND_DIR.'Cloud/QueueService/Adapter/AbstractAdapter.php';
require_once NUKE_ZEND_DIR.'Cloud/QueueService/Exception.php';
require_once NUKE_ZEND_DIR.'Cloud/QueueService/Message.php';
    ...
    public function deleteQueue($queueId, $options = null)
{
    ...
    public function storeQueueMetadata($queueId, $metadata, $options = null)
    {
        ...
        require_once NUKE_ZEND_DIR.'Cloud/OperationNotAvailableException.php';
