...
require_once NUKE_ZEND_DIR.'Cloud/StorageService/Adapter.php';
require_once NUKE_ZEND_DIR.'Cloud/StorageService/Exception.php';
require_once NUKE_ZEND_DIR.'Service/Rackspace/Files.php';
