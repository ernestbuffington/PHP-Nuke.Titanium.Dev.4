...
require_once NUKE_ZEND_DIR.'Wildfire/Channel/Interface.php';
...
require_once NUKE_ZEND_DIR.'Controller/Plugin/Abstract.php';

/** Zend_Wildfire_Protocol_JsonStream */
require_once NUKE_ZEND_DIR.'Wildfire/Protocol/JsonStream.php';
...
class Zend_Wildfire_Channel_HttpHeaders extends Zend_Controller_Plugin_Abstract implements Zend_Wildfire_Channel_Interface
{
    ...
    public static function init($class = null)
    {
        if (self::$_instance !== null) {
            require_once NUKE_ZEND_DIR.'Wildfire/Exception.php';
