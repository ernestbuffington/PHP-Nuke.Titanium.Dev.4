...
/** Zend_Pdf_Page */
require_once NUKE_ZEND_DIR.'Pdf/Page.php';

/** Zend_Pdf_Style */
require_once NUKE_ZEND_DIR.'Pdf/Style.php';

/** Zend_Pdf_Color_GrayScale */
require_once NUKE_ZEND_DIR.'Pdf/Color/GrayScale.php';

/** Zend_Pdf_Color_Rgb */
require_once NUKE_ZEND_DIR.'Pdf/Color/Rgb.php';

/** Zend_Pdf_Color_Cmyk */
require_once NUKE_ZEND_DIR.'Pdf/Color/Cmyk.php';

/** Zend_Pdf_Color_Html */
require_once NUKE_ZEND_DIR.'Pdf/Color/Html.php';

/** Zend_Pdf_Image */
require_once NUKE_ZEND_DIR.'Pdf/Image.php';

/** Zend_Pdf_Font */
require_once NUKE_ZEND_DIR.'Pdf/Font.php';

/** Zend_Pdf_Resource_Extractor */
require_once NUKE_ZEND_DIR.'Pdf/Resource/Extractor.php';

/** Zend_Pdf_Canvas */
require_once NUKE_ZEND_DIR.'Pdf/Canvas.php';


/** Internally used classes */
require_once NUKE_ZEND_DIR.'Pdf/Element.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Array.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/String/Binary.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Boolean.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Dictionary.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Name.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Null.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/Numeric.php';
require_once NUKE_ZEND_DIR.'Pdf/Element/String.php';
  ...
  /**** Class Constants ****/
    ...
    static public function getMemoryManager()
    {
        if (self::$_memoryManager === null) {
            require_once NUKE_ZEND_DIR.'Memory.php';
    ...
    {
        require_once NUKE_ZEND_DIR.'Pdf/ElementFactory.php';
        $this->_objFactory = Zend_Pdf_ElementFactory::createFactory(1);

        if ($source !== null) {
            require_once NUKE_ZEND_DIR.'Pdf/Parser.php';
            ...
            require_once NUKE_ZEND_DIR.'Pdf/Trailer/Generator.php';
    ...
    protected function _loadNamedDestinations(Zend_Pdf_Element_Reference $root, $pdfHeaderVersion)
    {
        ...
        if ($versionIs_1_2_plus) {
            ...
            if ($root->Names !== null  &&  $root->Names->Dests !== null) {
                require_once NUKE_ZEND_DIR.'Pdf/NameTree.php';
                require_once NUKE_ZEND_DIR.'Pdf/Target.php';
    ...
    protected function _loadOutlines(Zend_Pdf_Element_Reference $root)
    {
        ...
        while ($outlineDictionary !== null  &&  !$processedDictionaries->contains($outlineDictionary)) {
            ...
            require_once NUKE_ZEND_DIR.'Pdf/Outline/Loaded.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        require_once NUKE_ZEND_DIR.'Pdf/RecursivelyIteratableObjectsContainer.php';
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                // Try to extract font
                require_once NUKE_ZEND_DIR.'Pdf/Resource/Font/Extracted.php';
