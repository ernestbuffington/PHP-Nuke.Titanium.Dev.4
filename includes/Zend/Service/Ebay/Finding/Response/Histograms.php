 ...
 */
require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Response/Abstract.php';
...
class Zend_Service_Ebay_Finding_Response_Histograms extends Zend_Service_Ebay_Finding_Response_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($node) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Aspect/Histogram/Container.php';
        ...
        if ($node) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Category/Histogram/Container.php';
