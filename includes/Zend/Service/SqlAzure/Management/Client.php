 ...
 */
 require_once NUKE_ZEND_DIR.'Service/WindowsAzure/RetryPolicy/RetryPolicyAbstract.php';

 /**
 * @see Zend_Service_SqlAzure_Management_ServerInstance
 */
 require_once NUKE_ZEND_DIR.'Service/SqlAzure/Management/ServerInstance.php';

 /**
 * @see Zend_Service_SqlAzure_Management_FirewallRuleInstance
 */
 require_once NUKE_ZEND_DIR.'Service/SqlAzure/Management/FirewallRuleInstance.php';
...
class Zend_Service_SqlAzure_Management_Client
{
	...
	{
		if (is_null($response)) {
			require_once NUKE_ZEND_DIR.'Service/SqlAzure/Exception.php';
	...
	public function createServer($administratorLogin, $administratorPassword, $location)
	{
		if ($administratorLogin == '' || is_null($administratorLogin)) {
                    require_once NUKE_ZEND_DIR.'Service/SqlAzure/Management/Exception.php';
