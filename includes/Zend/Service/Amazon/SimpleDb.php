 ...
 */
require_once NUKE_ZEND_DIR.'Service/Amazon/Abstract.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Response
 */
require_once NUKE_ZEND_DIR.'Service/Amazon/SimpleDb/Response.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Page
 */
require_once NUKE_ZEND_DIR.'Service/Amazon/SimpleDb/Page.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Service/Amazon/SimpleDb/Exception.php';

/**
 * @see Zend_Crypt_Hmac
 */
require_once NUKE_ZEND_DIR.'Crypt/Hmac.php';
