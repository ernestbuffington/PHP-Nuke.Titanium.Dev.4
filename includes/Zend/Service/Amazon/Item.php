...
class Zend_Service_Amazon_Item
{
    ...
    {
        if (null === $dom) {
            require_once NUKE_ZEND_DIR.'Service/Amazon/Exception.php';
        ...
        foreach (['SmallImage', 'MediumImage', 'LargeImage'] as $im) {
            ...
            if ($result->length == 1) {
                 ...
                 */
                require_once NUKE_ZEND_DIR.'Service/Amazon/Image.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/CustomerReview.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/EditorialReview.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/SimilarProduct.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/ListmaniaList.php';
            foreach ($result as $r) {
        ...
        if ($result->length > 1 || $resultSummary->length == 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/OfferSet.php';
        ...
        if ($result->length > 1) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Amazon/Accessories.php';
            foreach ($result as $r) {
