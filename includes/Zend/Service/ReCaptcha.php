...
require_once NUKE_ZEND_DIR.'Service/Abstract.php';

/** @see Zend_Json */
require_once NUKE_ZEND_DIR.'Json.php';

/** @see Zend_Service_ReCaptcha_Response */
require_once NUKE_ZEND_DIR.'Service/ReCaptcha/Response.php';
...
class Zend_Service_ReCaptcha extends Zend_Service_Abstract
{
    ...
    public function setParams($params)
    {
        ...
        if (is_array($params)) {
            ...
            require_once NUKE_ZEND_DIR.'Service/ReCaptcha/Exception.php';
