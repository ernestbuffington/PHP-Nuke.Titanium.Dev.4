 ...
 */
require_once NUKE_ZEND_DIR.'Service/Console/Command.php';

/**
 * @see Zend_Service_WindowsAzure_Management_Client
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/Client.php';
	...
	extends Zend_Service_Console_Command
{
	...
	public function createFromStorageCommand($subscriptionId, $certificate, $certificatePassphrase, $serviceName, $deploymentName, $label, $staging, $production, $packageUrl, $serviceConfigurationLocation, $startImmediately = true, $warningsAsErrors = false, $waitForOperation = false)
	{
		...
		if (!$staging && !$production) {
			require_once NUKE_ZEND_DIR.'Service/Console/Exception.php';
