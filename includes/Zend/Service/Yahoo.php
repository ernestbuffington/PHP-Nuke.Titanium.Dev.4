...
class Zend_Service_Yahoo
{
    ...
    public function __construct($appId)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Rest/Client.php';
    ...
    public function inlinkDataSearch($query, array $options = [])
    {
        ...
        if ($response->isError()) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Exception.php';
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/InlinkDataResultSet.php';
    ...
    public function imageSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/ImageResultSet.php';
    ...
    public function localSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/LocalResultSet.php';
    ...
    public function newsSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/NewsResultSet.php';
    ...
    public function pageDataSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/PageDataResultSet.php';
    ...
    public function videoSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/VideoResultSet.php';
    ...
    public function webSearch($query, array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Yahoo/WebResultSet.php';
    ...
    protected function _validateInlinkDataSearch(array $options)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Validate/Between.php';
