...
require_once NUKE_ZEND_DIR.'Feed/Writer/Feed.php';

/** @see Zend_Version */
require_once NUKE_ZEND_DIR.'Version.php';

/** @see Zend_Feed_Writer_Renderer_RendererInterface */
require_once NUKE_ZEND_DIR.'Feed/Writer/Renderer/RendererInterface.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom */
require_once NUKE_ZEND_DIR.'Feed/Writer/Renderer/Entry/Atom.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom_Deleted */
require_once NUKE_ZEND_DIR.'Feed/Writer/Renderer/Entry/Atom/Deleted.php';

/** @see Zend_Feed_Writer_Renderer_RendererAbstract */
require_once NUKE_ZEND_DIR.'Feed/Writer/Renderer/RendererAbstract.php';

require_once NUKE_ZEND_DIR.'Feed/Writer/Renderer/Feed/Atom/AtomAbstract.php';
