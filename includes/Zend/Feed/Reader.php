 ...
 * @see Zend_Feed
 */
require_once NUKE_ZEND_DIR.'Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once NUKE_ZEND_DIR.'Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once NUKE_ZEND_DIR.'Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once NUKE_ZEND_DIR.'Feed/Reader/FeedSet.php';

/** @see Zend_Xml_Security */
require_once NUKE_ZEND_DIR.'Xml/Security.php';

/** @see Zend_Xml_Exception */
require_once NUKE_ZEND_DIR.'Xml/Exception.php';
