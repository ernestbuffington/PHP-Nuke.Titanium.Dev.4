...
require_once NUKE_ZEND_DIR.'Controller/Front.php';

/** @see Zend_Controller_Action_HelperBroker */
require_once NUKE_ZEND_DIR.'Controller/Action/HelperBroker.php';

/** @see Zend_Layout */
require_once NUKE_ZEND_DIR.'Layout.php';

/** @see Zend_Session */
require_once NUKE_ZEND_DIR.'Session.php';

/** @see Zend_Registry */
require_once NUKE_ZEND_DIR.'Registry.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        require_once NUKE_ZEND_DIR.'Test/PHPUnit/Constraint/DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once NUKE_ZEND_DIR.'Test/PHPUnit/Constraint/Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once NUKE_ZEND_DIR.'Test/PHPUnit/Constraint/ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once NUKE_ZEND_DIR.'Controller/Request/HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            require_once NUKE_ZEND_DIR.'Controller/Response/HttpTestCase.php';
    ...
    {
        if (null === $this->_query) {
            require_once NUKE_ZEND_DIR.'Dom/Query.php';
