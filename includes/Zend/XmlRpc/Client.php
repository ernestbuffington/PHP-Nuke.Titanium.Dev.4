 ...
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Client/ServerProxy.php';

/**
 * Introspects remote servers using the XML-RPC de facto system.* methods
 * @see Zend_XmlRpc_Client_ServerIntrospection
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Client/ServerIntrospection.php';
 ...
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Fault.php';
   ...
   /**
    ...
    public function doRequest($request, $response = null)
    {
        ...
        if (! $httpResponse->isSuccessful()) {
             ...
             */
            require_once NUKE_ZEND_DIR.'XmlRpc/Client/HttpException.php';
    ...
    public function call($method, $params=[])
    {
        ...
        if ($this->_lastResponse->isFault()) {
             ...
             */
            require_once NUKE_ZEND_DIR.'XmlRpc/Client/FaultException.php';
