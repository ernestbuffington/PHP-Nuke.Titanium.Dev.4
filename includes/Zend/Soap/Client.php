 ...
 */
require_once NUKE_ZEND_DIR.'Soap/Server.php';

/**
 * @see Zend_Soap_Client_Local
 */
require_once NUKE_ZEND_DIR.'Soap/Client/Local.php';

/**
 * @see Zend_Soap_Client_Common
 */
require_once NUKE_ZEND_DIR.'Soap/Client/Common.php';
...
class Zend_Soap_Client
{
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once NUKE_ZEND_DIR.'Soap/Client/Exception.php';
