 ...
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Loader/Abstract.php';

/**
 * @see Zend_Tool_Framework_Loader_IncludePathLoader_RecursiveFilterIterator
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Loader/IncludePathLoader/RecursiveFilterIterator.php';
