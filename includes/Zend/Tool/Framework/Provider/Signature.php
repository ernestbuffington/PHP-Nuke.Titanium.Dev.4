 ...
 */
require_once NUKE_ZEND_DIR.'Reflection/Class.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Action/Base.php';
    ...
    protected function _processSpecialties()
    {
        ...
        if ($this->_providerReflection->hasMethod('getSpecialties')) {
            ...
            if (!is_array($specialties)) {
                require_once NUKE_ZEND_DIR.'Tool/Framework/Provider/Exception.php';
