...
class Zend_Tool_Framework_Client_Interactive_InputHandler
{
    ...
    public function setInputRequest($inputRequest)
    {
        if (is_string($inputRequest)) {
            require_once NUKE_ZEND_DIR.'Tool/Framework/Client/Interactive/InputRequest.php';
    ...
    public function handle()
    {
        ...
        if (is_string($inputResponse)) {
            require_once NUKE_ZEND_DIR.'Tool/Framework/Client/Interactive/InputResponse.php';
