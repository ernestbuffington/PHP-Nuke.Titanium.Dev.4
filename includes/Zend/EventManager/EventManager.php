...
require_once NUKE_ZEND_DIR.'EventManager/Event.php';
require_once NUKE_ZEND_DIR.'EventManager/EventCollection.php';
require_once NUKE_ZEND_DIR.'EventManager/ResponseCollection.php';
require_once NUKE_ZEND_DIR.'EventManager/SharedEventCollectionAware.php';
require_once NUKE_ZEND_DIR.'EventManager/StaticEventManager.php';
require_once NUKE_ZEND_DIR.'Stdlib/CallbackHandler.php';
require_once NUKE_ZEND_DIR.'Stdlib/PriorityQueue.php';
...
class Zend_EventManager_EventManager implements Zend_EventManager_EventCollection, Zend_EventManager_SharedEventCollectionAware
{
    ...
    public function trigger($event, $target = null, $argv = [], $callback = null)
    {
        ...
        if ($callback && !is_callable($callback)) {
            require_once NUKE_ZEND_DIR.'Stdlib/Exception/InvalidCallbackException.php';
    ...
    public function attach($event, $callback = null, $priority = 1)
    {
        ...
        if (null === $callback) {
            require_once NUKE_ZEND_DIR.'EventManager/Exception/InvalidArgumentException.php';
