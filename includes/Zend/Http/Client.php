 ...
 */
require_once NUKE_ZEND_DIR.'Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Header_HeaderValue
 */
require_once NUKE_ZEND_DIR.'Http/Header/HeaderValue.php';


/**
 * @see Zend_Http_Response
 */
require_once NUKE_ZEND_DIR.'Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once NUKE_ZEND_DIR.'Http/Response/Stream.php';
...
class Zend_Http_Client
{
    ...
    protected function _validateHeaderValue($value, $recurse = true)
    {
        ...
        if (! is_string($value) && (! is_object($value) || ! method_exists($value, '__toString'))) {
            require_once NUKE_ZEND_DIR.'Http/Exception.php';
