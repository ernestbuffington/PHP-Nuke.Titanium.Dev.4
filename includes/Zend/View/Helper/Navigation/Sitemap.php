 ...
 */
require_once NUKE_ZEND_DIR.'View/Helper/Navigation/HelperAbstract.php';
    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    {
        require_once NUKE_ZEND_DIR.'Uri.php';
        ...
        if ($uri->valid()) {
            ...
            require_once NUKE_ZEND_DIR.'Uri/Exception.php';
    ...
    public function getDomSitemap(Zend_Navigation_Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            require_once NUKE_ZEND_DIR.'Validate/Sitemap/Changefreq.php';
            require_once NUKE_ZEND_DIR.'Validate/Sitemap/Lastmod.php';
            require_once NUKE_ZEND_DIR.'Validate/Sitemap/Loc.php';
            require_once NUKE_ZEND_DIR.'Validate/Sitemap/Priority.php';
        ...
        foreach ($iterator as $page) {
            ...
            if ($this->getUseSitemapValidators() &&
                ...
                require_once NUKE_ZEND_DIR.'View/Exception.php';
