 ...
 */
require_once NUKE_ZEND_DIR.'Amf/Value/Messaging/AsyncMessage.php';
/**
 ...
 */
require_once NUKE_ZEND_DIR.'Amf/Value/Messaging/RemotingMessage.php';
...
final class Zend_Amf_Parse_TypeLoader
{
    ...
    {
        if(!self::$_resourceLoader) {
            require_once NUKE_ZEND_DIR.'Amf/Exception.php';
