 ...
 */
require_once NUKE_ZEND_DIR.'Ldap/Node/Schema/AttributeType/ActiveDirectory.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_ActiveDirectory
 */
require_once NUKE_ZEND_DIR.'Ldap/Node/Schema/ObjectClass/ActiveDirectory.php';
