 ...
 */
require_once NUKE_ZEND_DIR.'Navigation/Container.php';
...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
    ...
    public static function factory($options)
    {
        ...
        if ($hasMvc) {
            require_once NUKE_ZEND_DIR.'Navigation/Page/Mvc.php';
            return new Zend_Navigation_Page_Mvc($options);
        } elseif ($hasUri) {
            require_once NUKE_ZEND_DIR.'Navigation/Page/Uri.php';
