...
/** @see Zend_Filter */
require_once NUKE_ZEND_DIR.'Filter.php';

/** @see Zend_Form */
require_once NUKE_ZEND_DIR.'Form.php';

/** @see Zend_Validate_Interface */
require_once NUKE_ZEND_DIR.'Validate/Interface.php';

/** @see Zend_Validate_Abstract */
require_once NUKE_ZEND_DIR.'Validate/Abstract.php';
...
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function __construct($spec, $options = null)
    {
        ...
        if (null === $this->getName()) {
            require_once NUKE_ZEND_DIR.'Form/Exception.php';
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once NUKE_ZEND_DIR.'Form/Element/Exception.php';
