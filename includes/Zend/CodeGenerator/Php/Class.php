 ...
 */
require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Abstract.php';

/**
 * @see Zend_CodeGenerator_Php_Member_Container
 */
require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Member/Container.php';

/**
 * @see Zend_CodeGenerator_Php_Method
 */
require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Method.php';

/**
 * @see Zend_CodeGenerator_Php_Property
 */
require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Property.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock
 */
require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Docblock.php';
...
class Zend_CodeGenerator_Php_Class extends Zend_CodeGenerator_Php_Abstract
{
    ...
    public function setDocblock($docblock)
    {
        ...
        if (is_array($docblock)) {
            ...
            require_once NUKE_ZEND_DIR.'CodeGenerator/Php/Exception.php';
