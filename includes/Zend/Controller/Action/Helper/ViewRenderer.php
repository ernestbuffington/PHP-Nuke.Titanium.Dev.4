 ...
 */
require_once NUKE_ZEND_DIR.'Controller/Action/Helper/Abstract.php';

/**
 * @see Zend_View
 */
require_once NUKE_ZEND_DIR.'View.php';
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Controller/Action/Exception.php';
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Filter/Inflector.php';
            /**
             * @see Zend_Filter_PregReplace
             */
            require_once NUKE_ZEND_DIR.'Filter/PregReplace.php';
            /**
             * @see Zend_Filter_Word_UnderscoreToSeparator
             */
            require_once NUKE_ZEND_DIR.'Filter/Word/UnderscoreToSeparator.php';
    ...
    protected function _translateSpec(array $vars = [])
    {
        ...
        require_once NUKE_ZEND_DIR.'Filter/Word/CamelCaseToDash.php';
