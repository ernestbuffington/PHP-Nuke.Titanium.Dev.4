...
abstract class Zend_Pdf_Image
{
  ...
  /* Factory Methods */
    ...
    public static function imageWithPath($filePath)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Pdf/Resource/ImageFactory.php';
    ...
    protected static function _extractJpegImage($dataSource)
    {
        ...
        require_once NUKE_ZEND_DIR.'Pdf/FileParser/Image/Jpeg.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Jpeg($dataSource);
        require_once NUKE_ZEND_DIR.'Pdf/Resource/Image/Jpeg.php';
    ...
    {
        require_once NUKE_ZEND_DIR.'Pdf/FileParser/Image/Png.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Png($dataSource);
        require_once NUKE_ZEND_DIR.'Pdf/Resource/Image/Png.php';
    ...
    protected static function _extractTiffImage($dataSource)
    {
        ...
        require_once NUKE_ZEND_DIR.'Pdf/FileParser/Image/Tiff.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Tiff($dataSource);
        require_once NUKE_ZEND_DIR.'Pdf/Resource/Image/Tiff.php';
