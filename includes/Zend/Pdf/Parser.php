...
require_once NUKE_ZEND_DIR.'Pdf/StringParser.php';
...
class Zend_Pdf_Parser
{
    ...
    private function _loadXRefTable($offset)
    {
        ...
        require_once NUKE_ZEND_DIR.'Pdf/Element/Reference/Table.php';
        $refTable = new Zend_Pdf_Element_Reference_Table();
        require_once NUKE_ZEND_DIR.'Pdf/Element/Reference/Context.php';
        ...
        require_once NUKE_ZEND_DIR.'Pdf/Trailer/Keeper.php';
