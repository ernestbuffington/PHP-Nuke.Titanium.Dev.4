 ...
 * @see Zend_config
 */
require_once NUKE_ZEND_DIR.'Config.php';
/**
 * @see Zend_Filter
 */
 ...
 */
require_once NUKE_ZEND_DIR.'Markup/Renderer/TokenConverterInterface.php';
...
abstract class Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function addMarkup($name, $type, array $options)
    {
        if (!isset($options['group']) && ($type ^ self::TYPE_ALIAS)) {
            require_once NUKE_ZEND_DIR.'Markup/Renderer/Exception.php';
