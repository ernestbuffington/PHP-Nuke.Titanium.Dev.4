 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/App/FeedEntryParent.php';

/**
 * @see Zend_Gdata_App_Extension_Content
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Content.php';

/**
 * @see Zend_Gdata_App_Extension_Edited
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Edited.php';

/**
 * @see Zend_Gdata_App_Extension_Published
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Published.php';

/**
 * @see Zend_Gdata_App_Extension_Source
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Source.php';

/**
 * @see Zend_Gdata_App_Extension_Summary
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Summary.php';

/**
 * @see Zend_Gdata_App_Extension_Control
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Control.php';
