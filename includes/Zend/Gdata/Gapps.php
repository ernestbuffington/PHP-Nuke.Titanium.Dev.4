 ...
 * @see Zend_Gdata
 */
require_once NUKE_ZEND_DIR.'Gdata.php';

/**
 * @see Zend_Gdata_Gapps_UserFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/UserFeed.php';

/**
 * @see Zend_Gdata_Gapps_NicknameFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/NicknameFeed.php';

/**
 * @see Zend_Gdata_Gapps_GroupFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/GroupFeed.php';

/**
 * @see Zend_Gdata_Gapps_MemberFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/MemberFeed.php';

/**
 * @see Zend_Gdata_Gapps_OwnerFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/OwnerFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/EmailListFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListRecipientFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Gapps/EmailListRecipientFeed.php';
...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    public static function throwServiceExceptionIfDetected($e) {
        ...
        try {
            ...
            require_once NUKE_ZEND_DIR.'Gdata/Gapps/ServiceException.php';
