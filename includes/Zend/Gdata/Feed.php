 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/OpenSearchItemsPerPage.php';
