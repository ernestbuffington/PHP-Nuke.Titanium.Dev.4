 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension.php';

/**
 * @see Zend_Gdata_Extension_Where
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/Where.php';

/**
 * @see Zend_Gdata_Extension_When
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/When.php';

/**
 * @see Zend_Gdata_Extension_Who
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/Who.php';

/**
 * @see Zend_Gdata_Extension_Recurrence
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/Recurrence.php';

/**
 * @see Zend_Gdata_Extension_EventStatus
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/EventStatus.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/Transparency.php';

/**
 * @see Zend_Gdata_Extension_Visibility
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/Visibility.php';

/**
 * @see Zend_Gdata_Extension_ExtendedProperty
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/ExtendedProperty.php';

/**
 * @see Zend_Gdata_Extension_OriginalEvent
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/OriginalEvent.php';

/**
 * @see Zend_Gdata_Extension_EntryLink
 */
require_once NUKE_ZEND_DIR.'Gdata/Extension/EntryLink.php';
...
class Zend_Gdata_Kind_EventEntry extends Zend_Gdata_Entry
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gd') . ':' . 'recurrenceException';
            require_once NUKE_ZEND_DIR.'Gdata/Extension/RecurrenceException.php';
