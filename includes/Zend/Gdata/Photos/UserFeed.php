 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos/UserEntry.php';

/**
 * @see Zend_Gdata_Photos_AlbumEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos/AlbumEntry.php';

/**
 * @see Zend_Gdata_Photos_PhotoEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos/PhotoEntry.php';

/**
 * @see Zend_Gdata_Photos_TagEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos/TagEntry.php';

/**
 * @see Zend_Gdata_Photos_CommentEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Photos/CommentEntry.php';
