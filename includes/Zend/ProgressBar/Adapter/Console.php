 ...
 */
require_once NUKE_ZEND_DIR.'ProgressBar/Adapter.php';

/**
 * @see Zend_Text_MultiByte
 */
require_once NUKE_ZEND_DIR.'Text/MultiByte.php';
...
class Zend_ProgressBar_Adapter_Console extends Zend_ProgressBar_Adapter
{
    ...
    public function setOutputStream($resource)
    {
       ...
       if ($stream === false) {
            require_once NUKE_ZEND_DIR.'ProgressBar/Adapter/Exception.php';
