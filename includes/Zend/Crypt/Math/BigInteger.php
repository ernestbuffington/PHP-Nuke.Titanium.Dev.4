...
class Zend_Crypt_Math_BigInteger
{
    ...
    public function __call($methodName, $args)
    {
        if(!method_exists($this->_math, $methodName)) {
            require_once NUKE_ZEND_DIR.'Crypt/Math/BigInteger/Exception.php';
