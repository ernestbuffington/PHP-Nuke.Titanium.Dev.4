...
require_once NUKE_ZEND_DIR.'Memory/Container/Movable.php';

/** Zend_Memory_Container_Locked */
require_once NUKE_ZEND_DIR.'Memory/Container/Locked.php';

/** Zend_Memory_AccessController */
require_once NUKE_ZEND_DIR.'Memory/AccessController.php';
...
class Zend_Memory_Manager
{
    ...
    private function _swapCheck()
    {
        ...
        require_once NUKE_ZEND_DIR.'Memory/Exception.php';
