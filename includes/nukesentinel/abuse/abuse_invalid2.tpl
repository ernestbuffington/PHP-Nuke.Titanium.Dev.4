...
<p align="center"><img src="includes/nukesentinel/abuse/logo.png" width="468" height="60" alt="" /><br /><b>You have attempted to access this site with an invalid User Agent.</b></p>
...
<b>Forwarded For:</b> __FORWARDEDFOR__</p></td></tr>
