...
function show_copyright($author_name = "", $author_user_email = "", $author_homepage = "", $license = "", $download_location = "", $titanium_module_version = "", $titanium_module_description = "") {
...
';
    echo "//-->\n"
        ...
        ."$titanium_module_name module for <a href='http://www.nuke-evolution.com' target='_blank'>Nuke-Evolution</a><br /><br /></center>\n"
        ."<img src='../../images/arrow.gif' border='0' alt='' />&nbsp;<strong>Module's Name:</strong> $titanium_module_name<br />\n"
        ."<img src='../../images/arrow.gif' border='0' alt='' />&nbsp;<strong>Module's Version:</strong> $titanium_module_version<br />\n"
        ."<img src='../../images/arrow.gif' border='0' alt='' />&nbsp;<strong>Module's Description:</strong> $titanium_module_description<br />\n"
