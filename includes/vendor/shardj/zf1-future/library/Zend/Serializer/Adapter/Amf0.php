...
require_once NUKE_ZEND_DIR.'Serializer/Adapter/AdapterAbstract.php';

/** @see Zend_Amf_Parse_OutputStream */
require_once NUKE_ZEND_DIR.'Amf/Parse/OutputStream.php';

/** @see Zend_Amf_Parse_Amf0_Serializer */
require_once NUKE_ZEND_DIR.'Amf/Parse/Amf0/Serializer.php';

/** @see Zend_Amf_Parse_InputStream */
require_once NUKE_ZEND_DIR.'Amf/Parse/InputStream.php';

/** @see Zend_Amf_Parse_Amf0_Deserializer */
require_once NUKE_ZEND_DIR.'Amf/Parse/Amf0/Deserializer.php';
...
class Zend_Serializer_Adapter_Amf0 extends Zend_Serializer_Adapter_AdapterAbstract
{
    ...
    public function serialize($value, array $opts = [])
    {
        try  {
            ...
            require_once NUKE_ZEND_DIR.'Serializer/Exception.php';
