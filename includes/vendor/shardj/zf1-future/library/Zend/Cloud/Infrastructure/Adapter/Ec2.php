...
require_once NUKE_ZEND_DIR.'Service/Amazon/Ec2/Instance.php';
require_once NUKE_ZEND_DIR.'Service/Amazon/Ec2/Image.php';
require_once NUKE_ZEND_DIR.'Service/Amazon/Ec2/Availabilityzones.php';
require_once NUKE_ZEND_DIR.'Service/Amazon/Ec2/CloudWatch.php';
require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/Instance.php';
require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/InstanceList.php';
require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/Image.php';
require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/ImageList.php';
require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/Adapter/AbstractAdapter.php';
...
class Zend_Cloud_Infrastructure_Adapter_Ec2 extends Zend_Cloud_Infrastructure_Adapter_AbstractAdapter
{
    ...
    public function __construct($options = [])
    {
        ...
        if (empty($options) || !is_array($options)) {
            require_once NUKE_ZEND_DIR.'Cloud/Infrastructure/Exception.php';
