...
require_once NUKE_ZEND_DIR.'Cloud/DocumentService/Adapter/AbstractAdapter.php';
require_once NUKE_ZEND_DIR.'Cloud/DocumentService/Adapter/WindowsAzure/Query.php';
require_once NUKE_ZEND_DIR.'Cloud/DocumentService/Exception.php';
