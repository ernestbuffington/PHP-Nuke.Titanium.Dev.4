 ...
 */
require_once NUKE_ZEND_DIR.'Feed/Builder/Interface.php';

/**
 * @see Zend_Feed_Builder_Header
 */
require_once NUKE_ZEND_DIR.'Feed/Builder/Header.php';

/**
 * @see Zend_Feed_Builder_Entry
 */
require_once NUKE_ZEND_DIR.'Feed/Builder/Entry.php';
