 ...
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Client/Abstract.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_InputInterface
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Client/Interactive/InputInterface.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_OutputInterface
 */
require_once NUKE_ZEND_DIR.'Tool/Framework/Client/Interactive/OutputInterface.php';
