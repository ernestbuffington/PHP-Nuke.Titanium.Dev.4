...
require_once NUKE_ZEND_DIR.'Controller/Router/Abstract.php';

/** Zend_Controller_Router_Route */
require_once NUKE_ZEND_DIR.'Controller/Router/Route.php';
...
class Zend_Controller_Router_Rewrite extends Zend_Controller_Router_Abstract
{
    ...
    public function addDefaultRoutes()
    {
        if (!$this->hasRoute('default')) {
            ...
            require_once NUKE_ZEND_DIR.'Controller/Router/Route/Module.php';
    ...
    public function addConfig(Zend_Config $config, $section = null)
    {
        if ($section !== null) {
            if ($config->{$section} === null) {
                require_once NUKE_ZEND_DIR.'Controller/Router/Exception.php';
