 ...
 */
require_once NUKE_ZEND_DIR.'Barcode/Object/Ean13.php';

/**
 * @see Zend_Validate_Barcode
 */
require_once NUKE_ZEND_DIR.'Validate/Barcode.php';
...
class Zend_Barcode_Object_Ean8 extends Zend_Barcode_Object_Ean13
{
    ...
    protected function _validateText($value, $options = [])
    {
        ...
        if (!$validator->isValid($value)) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Barcode/Object/Exception.php';
