 ...
 */
require_once NUKE_ZEND_DIR.'View/Helper/Navigation/Helper.php';

/**
 * @see Zend_View_Helper_HtmlElement
 */
require_once NUKE_ZEND_DIR.'View/Helper/HtmlElement.php';
    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            require_once NUKE_ZEND_DIR.'Navigation.php';
