 ...
 */
require_once NUKE_ZEND_DIR.'Session/Abstract.php';

/**
 * @see Zend_Session_Namespace
 */
require_once NUKE_ZEND_DIR.'Session/Namespace.php';

/**
 * @see Zend_Session_SaveHandler_Interface
 */
require_once NUKE_ZEND_DIR.'Session/SaveHandler/Interface.php';
    ...
    public static function setOptions(array $userOptions = [])
    {
        ...
        foreach ($userOptions as $userOptionName => $userOptionValue) {
            ...
            elseif (isset(self::$_localOptions[$userOptionName])) {
                ...
                require_once NUKE_ZEND_DIR.'Session/Exception.php';
    ...
    private static function _processValidators()
    {
        foreach ($_SESSION['__ZF']['VALID'] as $validator_name => $valid_data) {
            ...
            if ($validator->validate() === false) {
                ...
                require_once NUKE_ZEND_DIR.'Session/Validator/Exception.php';
