 ...
 */
require_once NUKE_ZEND_DIR.'Filter/Encrypt/Interface.php';

/** @see Zend_Crypt_Math */
require_once NUKE_ZEND_DIR.'Crypt/Math.php';
...
class Zend_Filter_Encrypt_Mcrypt implements Zend_Filter_Encrypt_Interface
{
    ...
    public function encrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once NUKE_ZEND_DIR.'Filter/Compress.php';
    ...
    public function decrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once NUKE_ZEND_DIR.'Filter/Decompress.php';
