 ...
 */
require_once NUKE_ZEND_DIR.'Mime/Decode.php';

/**
 * @see Zend_Mail_Header_HeaderName
 */
require_once NUKE_ZEND_DIR.'Mail/Header/HeaderName.php';

/**
 * @see Zend_Mail_Header_HeaderValue
 */
require_once NUKE_ZEND_DIR.'Mail/Header/HeaderValue.php';

/**
 * @see Zend_Mail_Part_Interface
 */
require_once NUKE_ZEND_DIR.'Mail/Part/Interface.php';
