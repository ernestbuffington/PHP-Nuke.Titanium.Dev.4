    ...
    public static function getGenerator()
    {
        if (!self::$_generator) {
            if (extension_loaded('xmlwriter')) {
                require_once NUKE_ZEND_DIR.'XmlRpc/Generator/XmlWriter.php';
                self::$_generator = new Zend_XmlRpc_Generator_XmlWriter();
            } else {
                require_once NUKE_ZEND_DIR.'XmlRpc/Generator/DomDocument.php';
