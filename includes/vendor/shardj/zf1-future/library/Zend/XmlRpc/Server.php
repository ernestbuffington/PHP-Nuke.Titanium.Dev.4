 ...
 */
require_once NUKE_ZEND_DIR.'Server/Abstract.php';

/**
 * XMLRPC Request
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Request.php';

/**
 * XMLRPC Response
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Response.php';

/**
 * XMLRPC HTTP Response
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Response/Http.php';

/**
 * XMLRPC server fault class
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Server/Fault.php';

/**
 * XMLRPC server system methods class
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Server/System.php';

/**
 * Convert PHP to and from xmlrpc native types
 */
require_once NUKE_ZEND_DIR.'XmlRpc/Value.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Server/Reflection/Function/Abstract.php';
 ...
 */
require_once NUKE_ZEND_DIR.'Server/Reflection/Method.php';
 ...
 * Example:
 * <code>
 * require_once NUKE_ZEND_DIR.'XmlRpc/Server.php';
 * require_once NUKE_ZEND_DIR.'XmlRpc/Server/Cache.php';
 * require_once NUKE_ZEND_DIR.'XmlRpc/Server/Fault.php';
...
class Zend_XmlRpc_Server extends Zend_Server_Abstract
{
    ...
    public function __call($method, $params)
    {
        ...
        if (!method_exists($system, $method)) {
            require_once NUKE_ZEND_DIR.'XmlRpc/Server/Exception.php';
    ...
    public function handle($request = false)
    {
        ...
        if ((!$request || !$request instanceof Zend_XmlRpc_Request)
            ...
            require_once NUKE_ZEND_DIR.'XmlRpc/Request/Http.php';
