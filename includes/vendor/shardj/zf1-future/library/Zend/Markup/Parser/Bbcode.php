 ...
 */
require_once NUKE_ZEND_DIR.'Markup/TokenList.php';

/**
 * @see Zend_Markup_Parser_ParserInterface
 */
require_once NUKE_ZEND_DIR.'Markup/Parser/ParserInterface.php';
...
class Zend_Markup_Parser_Bbcode implements Zend_Markup_Parser_ParserInterface
{
    ...
    public function parse($value)
    {
        if (!is_string($value)) {
             ...
             */
            require_once NUKE_ZEND_DIR.'Markup/Parser/Exception.php';
