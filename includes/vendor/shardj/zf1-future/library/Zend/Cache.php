...
abstract class Zend_Cache
{
    ...
    public static function _makeBackend($backend, $backendOptions, $customBackendNaming = false, $autoload = false)
    {
        ...
        if (in_array($backend, Zend_Cache::$standardBackends)) {
            ...
            require_once str_replace('_', DIRECTORY_SEPARATOR, 'includes/vendor/shardj/zf1-future/library/' .$backendClass) . '.php';
        } else {
    ...
    public static function _makeFrontend($frontend, $frontendOptions = [], $customFrontendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            // security controls are explicit
            require_once str_replace('_', DIRECTORY_SEPARATOR, 'includes/vendor/shardj/zf1-future/library/' .$frontendClass) . '.php';
