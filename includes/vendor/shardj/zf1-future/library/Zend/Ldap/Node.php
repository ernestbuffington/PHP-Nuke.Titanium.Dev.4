 ...
 * @see Zend_Ldap
 */
require_once NUKE_ZEND_DIR.'Ldap.php';
/**
 * @see Zend_Ldap_Node_Abstract
 */
require_once NUKE_ZEND_DIR.'Ldap/Node/Abstract.php';
...
class Zend_Ldap_Node extends Zend_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    ...
    */
    ...
    public function toLdif(array $options = [])
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Ldap/Ldif/Encoder.php';
    ...
    public function searchSubtree($filter, $scope = Zend_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Ldap/Node/Collection.php';
    ...
    public function getChildren(): ?\RecursiveIterator
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Ldap/Node/ChildrenIterator.php';
