...
require_once NUKE_ZEND_DIR.'Pdf/ElementFactory/Interface.php';
...
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
        require_once NUKE_ZEND_DIR.'Pdf/ElementFactory/Proxy.php';
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        $result = [];
        require_once NUKE_ZEND_DIR.'Pdf/UpdateInfoContainer.php';
