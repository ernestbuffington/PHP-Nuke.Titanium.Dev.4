 ...
 */
require_once NUKE_ZEND_DIR.'Http/CookieJar.php';

/**
 * @see Zend_Oauth_Consumer
 */
require_once NUKE_ZEND_DIR.'Oauth/Consumer.php';

/**
 * @see Zend_Oauth_Token_Access
 */
require_once NUKE_ZEND_DIR.'Oauth/Token/Access.php';

/**
 * @see Zend_Service_Twitter_Response
 */
require_once NUKE_ZEND_DIR.'Service/Twitter/Response.php';
...
class Zend_Service_Twitter
{
    ...
    public function __get($type)
    {
        ...
        if (!in_array($type, $this->methodTypes)) {
            require_once NUKE_ZEND_DIR.'Service/Twitter/Exception.php';
