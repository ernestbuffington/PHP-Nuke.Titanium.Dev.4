 ...
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/OperationStatusInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_SubscriptionOperationInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/SubscriptionOperationInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_DeploymentInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/DeploymentInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_Blob
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Storage/Blob.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_Table
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Storage/Table.php';

/**
 * @see Zend_Service_WindowsAzure_Management_HostedServiceInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/HostedServiceInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_CertificateInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/CertificateInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_AffinityGroupInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/AffinityGroupInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_LocationInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/LocationInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_OperatingSystemInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/OperatingSystemInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_OperatingSystemFamilyInstance
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/OperatingSystemFamilyInstance.php';

/** @see Zend_Xml_Security */
require_once NUKE_ZEND_DIR.'Xml/Security.php';
...
class Zend_Service_WindowsAzure_Management_Client
{
	...
	{
		if (is_null($response)) {
			require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Exception.php';
    ...
    public function getOperationStatus($requestId = '')
    {
    	...
    	if ($response->isSuccessful()) {
			...
			require_once NUKE_ZEND_DIR.'Service/Management/Exception.php';
    ...
    public function listSubscriptionOperations($startTime, $endTime, $objectIdFilter = null, $operationResultFilter = null, $continuationToken = null)
    {
    	if ($startTime == '' || is_null($startTime)) {
			require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/Exception.php';
	...
	public function createQueueClientForService($serviceName, Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null)
	{
		...
		require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Storage/Queue.php';
    ...
    public function getStorageAccountProperties($serviceName)
    {
    	...
    	if ($response->isSuccessful()) {
			...
			if (!is_null($xmlService)) {
				require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Management/StorageServiceInstance.php';
