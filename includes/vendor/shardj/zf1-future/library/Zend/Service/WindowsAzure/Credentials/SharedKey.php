 ...
 */
require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Credentials/CredentialsAbstract.php';
    ...
    extends Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
{
	...
	public function signRequestHeaders(
		...
		// Table storage?
		if ($forTableStorage) {
			require_once NUKE_ZEND_DIR.'Service/WindowsAzure/Credentials/Exception.php';
