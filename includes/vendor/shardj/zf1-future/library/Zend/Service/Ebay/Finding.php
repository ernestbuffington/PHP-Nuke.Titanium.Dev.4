 ...
 */
require_once NUKE_ZEND_DIR.'Service/Ebay/Abstract.php';
...
class Zend_Service_Ebay_Finding extends Zend_Service_Ebay_Abstract
{
    ...
    public function __construct($options)
    {
        ...
        if (is_string($options)) {
            ...
            if (!array_key_exists(self::OPTION_APP_ID, $options)) {
                 ...
                 */
                require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Exception.php';
    ...
    protected function _findItems(array $options, $operation)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Response/Items.php';
    ...
    public function getHistograms($categoryId, $options = null)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Response/Histograms.php';
    ...
    public function getSearchKeywordsRecommendation($keywords, $options = null)
    {
         ...
         */
        require_once NUKE_ZEND_DIR.'Service/Ebay/Finding/Response/Keywords.php';
