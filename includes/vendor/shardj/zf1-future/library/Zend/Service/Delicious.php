 ...
 */
require_once NUKE_ZEND_DIR.'Json/Decoder.php';

/**
 * @see Zend_Service_Delicious_SimplePost
 */
require_once NUKE_ZEND_DIR.'Service/Delicious/SimplePost.php';

/**
 * @see Zend_Service_Delicious_Post
 */
require_once NUKE_ZEND_DIR.'Service/Delicious/Post.php';

/**
 * @see Zend_Service_Delicious_PostList
 */
require_once NUKE_ZEND_DIR.'Service/Delicious/PostList.php';
...
class Zend_Service_Delicious
{
    ...
    public function getLastUpdate()
    {
        ...
        if ($rootNode && $rootNode->nodeName == 'update') {
             ...
             */
            require_once NUKE_ZEND_DIR.'Service/Delicious/Exception.php';
