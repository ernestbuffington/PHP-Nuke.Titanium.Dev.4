 ...
 */
require_once NUKE_ZEND_DIR.'Acl/Resource/Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once NUKE_ZEND_DIR.'Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once NUKE_ZEND_DIR.'Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once NUKE_ZEND_DIR.'Acl/Role.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once NUKE_ZEND_DIR.'Acl/Exception.php';
