 ...
 */
require_once NUKE_ZEND_DIR.'Server/Reflection/Node.php';

/**
 * Zend_Server_Reflection_Parameter
 */
require_once NUKE_ZEND_DIR.'Server/Reflection/Parameter.php';

/**
 * Zend_Server_Reflection_Prototype
 */
require_once NUKE_ZEND_DIR.'Server/Reflection/Prototype.php';
...
abstract class Zend_Server_Reflection_Function_Abstract
{
    ...
    public function __construct(Reflector $r, $namespace = null, $argv = [])
    {
        ...
        if ((!$r instanceof ReflectionFunction)
            ...
            require_once NUKE_ZEND_DIR.'Server/Reflection/Exception.php';
