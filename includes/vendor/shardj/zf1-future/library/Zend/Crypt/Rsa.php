 ...
 */
require_once NUKE_ZEND_DIR.'Crypt/Rsa/Key/Private.php';

/**
 * @see Zend_Crypt_Rsa_Key_Public
 */
require_once NUKE_ZEND_DIR.'Crypt/Rsa/Key/Public.php';
...
class Zend_Crypt_Rsa
{
    ...
    public function __construct(array $options = null)
    {
        if (!extension_loaded('openssl')) {
            require_once NUKE_ZEND_DIR.'Crypt/Rsa/Exception.php';
