...
*/
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Author.php';
...
*/
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Extension/Updated.php';
