 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/ListEntry.php';
