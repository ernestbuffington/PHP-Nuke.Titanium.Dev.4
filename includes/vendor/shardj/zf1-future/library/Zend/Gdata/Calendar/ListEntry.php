 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/Extension/AccessLevel.php';

/**
 * @see Zend_Calendar_Extension_Color
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/Extension/Color.php';

/**
 * @see Zend_Calendar_Extension_Hidden
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/Extension/Hidden.php';

/**
 * @see Zend_Calendar_Extension_Selected
 */
require_once NUKE_ZEND_DIR.'Gdata/Calendar/Extension/Selected.php';
