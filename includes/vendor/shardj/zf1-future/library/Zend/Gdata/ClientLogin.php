 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/HttpClient.php';
...
class Zend_Gdata_ClientLogin
{
    ...
    {
        if (! ($email && $password)) {
            require_once NUKE_ZEND_DIR.'Gdata/App/AuthException.php';
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once NUKE_ZEND_DIR.'Gdata/App/CaptchaRequiredException.php';
