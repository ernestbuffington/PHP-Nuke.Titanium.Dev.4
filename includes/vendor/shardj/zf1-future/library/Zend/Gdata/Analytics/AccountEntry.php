 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/Analytics/Extension/Dimension.php';

/**
 * @see Zend_Gdata_Analytics_Extension_Metric
 */
require_once NUKE_ZEND_DIR.'Gdata/Analytics/Extension/Metric.php';

/**
 * @see Zend_Gdata_Analytics_Extension_Property
 */
require_once NUKE_ZEND_DIR.'Gdata/Analytics/Extension/Property.php';

/**
 * @see Zend_Gdata_Analytics_Extension_TableId
 */
require_once NUKE_ZEND_DIR.'Gdata/Analytics/Extension/TableId.php';
