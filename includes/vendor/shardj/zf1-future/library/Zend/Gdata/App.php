 ...
 * Zend_Gdata_Feed
 */
require_once NUKE_ZEND_DIR.'Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once NUKE_ZEND_DIR.'Http/Client.php';

/**
 * Zend_Version
 */
require_once NUKE_ZEND_DIR.'Version.php';

/**
 * Zend_Gdata_App_MediaSource
 */
require_once NUKE_ZEND_DIR.'Gdata/App/MediaSource.php';

/**
 * Zend_Uri/Http
 */
require_once NUKE_ZEND_DIR.'Uri/Http.php';
...
class Zend_Gdata_App
{
        ...
        $applicationId = 'MyCompany-MyApp-1.0')
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once NUKE_ZEND_DIR.'Gdata/App/HttpException.php';
    ...
    public static function setGzipEnabled($enabled = false)
    {
        if ($enabled && !function_exists('gzinflate')) {
            require_once NUKE_ZEND_DIR.'Gdata/App/InvalidArgumentException.php';
    ...
    {
        require_once NUKE_ZEND_DIR.'Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once NUKE_ZEND_DIR.'Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once NUKE_ZEND_DIR.'Gdata/HttpAdapterStreamingSocket.php';
        ...
        $minorProtocolVersion = null)
    {
        if (!class_exists($className, false)) {
          require_once NUKE_ZEND_DIR.'Loader.php';
