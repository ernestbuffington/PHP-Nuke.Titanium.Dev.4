 ...
 */
require_once NUKE_ZEND_DIR.'Gdata/DublinCore.php';

/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Books/CollectionEntry.php';

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Books/CollectionFeed.php';

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once NUKE_ZEND_DIR.'Gdata/Books/VolumeEntry.php';

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once NUKE_ZEND_DIR.'Gdata/Books/VolumeFeed.php';
