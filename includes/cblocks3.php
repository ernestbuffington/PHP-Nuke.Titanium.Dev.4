...
$cbinfo = $pnt_db->sql_fetchrow($pnt_db->sql_query("select * from `".$pnt_prefix."_nsncb_config` where `cgid`='3'"));
if($cbinfo['enabled'] == '1') {
    ...
    $result3 = $pnt_db->sql_query("SELECT * FROM `".$pnt_prefix."_nsncb_blocks` WHERE `cgid`='3' ORDER BY `cbid`");
