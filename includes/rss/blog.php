...
$result = $pnt_db->sql_query("SELECT s.sid, t.topicname, s.informant, s.title, s.datePublished, s.dateModified, s.hometext
                          FROM ".$pnt_prefix."_stories s, ".$pnt_prefix."_topics t
