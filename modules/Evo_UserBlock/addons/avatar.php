...
global $avatar_overide_size, $make_xtreme_avatar_small, $phpbb2_board_config, $userinfo;
...
{
  $phpbb2_board_config['avatar_max_height'] = $avatar_overide_size;
  $phpbb2_board_config['avatar_max_width'] = $avatar_overide_size;
}
...
$evouserinfo_avatar .= '<img class="rounded-corners-user-info" style="max-height: '.$phpbb2_board_config['avatar_max_height'].'px; max-width: '
