...
define("_FORUMSDATEMSG"," You must use the PHP <a href='http://www.php.net/date' target='_blank'>date()</a> syntax");
...
if (!defined('_NEWSLETTER')) define('_NEWSLETTER', 'Newsletter');
...
define("_YOUWILLRECEIVE","An email will be been sent to you containing an activation link. Please click on the link to activate your account.</br> If you do not click the link your account will remain inactive and you will not be able to login.</br> If you do not receive the email within a few minutes, please check your spam folder..");
