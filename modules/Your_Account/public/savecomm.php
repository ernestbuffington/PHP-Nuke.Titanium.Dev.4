...
if (!defined('CNBYA')) {
    ...
    if (($pnt_user_id == $vuid) AND ($check2 == $ccpass)) {
        ...
        $pnt_db->sql_query("UPDATE ".$pnt_user_prefix."_users SET umode='$umode', uorder='$uorder', thold='$thold', noscore='$noscore', commentmax='$commentmax' WHERE user_id='$pnt_user_id'");
