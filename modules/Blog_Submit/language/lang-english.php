...
define("_FRIEND","Send this Blog to a Friend");
define("_YOURNAME","Your Nickname");
define("_OK","Ok!");
define("_ALLOWEDHTML","Allowed HTML:");
define("_ALL","All");
define("_EXTRANS","Extrans (html tags to text)");
define("_HTMLFORMATTED","HTML Formated");
define("_PLAINTEXT","Plain Old Text");
define("_ARTICLES","Blogs");
define("_SUBMITNEWS","Submit Blog");
define("_SUBMITADVICE","Please write your blog/article/story filling the following form and double check your submission.<br />You're advised that not all submissions will be posted.<br />Your submission will be checked for proper grammar and maybe edited by our staff.");
...
define("_SELECTTOPIC","Select Blog Topic");
define("_NEWSUBPREVIEW","Blog Submission Preview");
define("_STORYLOOK","Your Blog will look something like this:");
define("_CHECKSTORY","Please check text, links, etc. before send your story!");
define("_THANKSSUB","Thanks for your submission!");
define("_SUBSENT","Your Blog has been received...");
...
define("_WAITING","Blog submissions waiting to be published.");
...
define("_ERROR_STORY","You must provide some text to the story");
define("_ERROR_SUBJECT","You must provide a subject");
