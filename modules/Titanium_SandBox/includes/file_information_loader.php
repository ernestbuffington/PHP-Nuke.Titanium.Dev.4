...
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox</font></b> ".$fpl_img."  Your facebook SandBox folder, which is relative to your portal root directory (public_html).<br>";
...
if( is_dir( $dir ) )
{
		...
		if( stripos( $file, '.' ) > 0)
		{
		   $fileCount++;
			...
			if ($file == $testfile)
			{
			   ...
			   $description = 'please add the file <font color=#CC0000>'.$file_description.'</font> to <b>modules/Titanium_SandBox/project_file_decriptions</b> folder.';
	...
	//echo $L_img." <b>This is the structure of your Titanium_SandBox module.<br />";
}       

echo '<hr>';
$dir = $dir_admin;
$php_dir = "<img align=\"absbottom\" width=\"17\" src=\"$folder\" border=\"0\">";
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/admin</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
...
echo '<hr>';
$dir = $dir_css;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/css</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
	$dir_array = scandir( $dir );
...
echo '<hr>';
$dir = $dir_facebook;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/facebook</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
...
echo '<hr>';
$dir = $dir_images;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/images</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
...
echo '<hr>';
$dir = $dir_includes;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/includes</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
	$dir_array = scandir( $dir );
...
echo '<hr>';
$dir = $dir_js;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/js</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
	$dir_array = scandir( $dir );
...
echo '<hr>';
$dir = $dir_songs;
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/songs</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
	$dir_array = scandir( $dir );
...
echo $php_dir. " <b><font color='$facebook_font_color'>modules/Titanium_SandBox/project_file_descriptions</font></b> ".$fpl_img." Module Sub Folder<br>";
if( is_dir( $dir ) )
{
	$dir_array = scandir( $dir );
