...
if ($form_done=="yes"):
	if (isset($catid) && $catid!="")
		$query = "update ".$pnt_prefix."_cemetery_cat set name='$catname',description='$catcomment',mod_date=now() where category_id='$catid'";
	else
		$query = "insert into ".$pnt_prefix."_cemetery_cat (user_id,name,description,mod_date) values ($pnt_userid,'$catname','$catcomment',now())";
