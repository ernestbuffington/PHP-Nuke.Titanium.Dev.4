...
echo "<table width='80%' border='1' style='margin: auto;'><tr><th scope='col'>".$lang_new[$pnt_module]['MODULE_CONFIG']."</th></tr></table>";
...
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$pnt_module]['SHOW_STANDARD'].":</strong></td>";
echo "    <td width='40%'>";
echo yesno_option('button_standard', $config['button_standard']);
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$pnt_module]['SHOW_BANNER'].":</strong></td>";
echo "    <td width='40%'>";
echo yesno_option('button_banner', $config['button_banner']);
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$pnt_module]['SHOW_RESOURCES'].":</strong></td>";
echo "    <td width='40%'>";
...
echo "<br /><div align='center'><input name='submit' type='submit' value='".$lang_new[$pnt_module]['UPDATE_MODULE_CONFIG']."' /></div>";
echo "</form>";
