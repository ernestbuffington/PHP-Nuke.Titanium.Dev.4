...
if($numrows == 0){
    echo "<center><font color='red' size='3'>".$titanium_lang_new[$titanium_module_name]['ALL_ACTIVE_SITES']."</font></center>";
} elseif ($numrows > 0) {
  ...
  if ($num ==1) { echo "<td width='50%'>&nbsp;</td></tr></table>"; } else { echo "</tr></table>"; }
	...
	LinkusTableOpen();
        ...
        echo "<br /><br /><a href='".$admin_file.".php?op=edit_button&amp;id=".$id."'><img src='images/linkus/edit.png' border='0' alt='".$titanium_lang_new[$titanium_module_name]['EDIT']."' title='".$titanium_lang_new[$titanium_module_name]['EDIT']."'></a>";
        echo " <a href='".$admin_file.".php?op=delete_button&amp;id=".$id."'><img src='images/linkus/delete.png' border='0' alt='".$titanium_lang_new[$titanium_module_name]['DELETE']."' title='".$titanium_lang_new[$titanium_module_name]['DELETE']."'></a>";
