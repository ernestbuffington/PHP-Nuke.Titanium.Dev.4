...
if($numrows == 0){
  ...
  if ($num ==1) { echo "<td width='50%'>&nbsp;</td></tr></table>"; } else { echo "</tr></table>"; }
	...
	LinkusTableOpen();
        ...
        echo "<br /><br /><a href='".$admin_file.".php?op=edit_button&amp;id=".$id."'><img src='images/linkus/edit.png' border='0' alt='".$lang_new[$pnt_module]['EDIT']."' title='".$lang_new[$pnt_module]['EDIT']."'></a>";
        echo " <a href='".$admin_file.".php?op=delete_button&amp;id=".$id."'><img src='images/linkus/delete.png' border='0' alt='".$lang_new[$pnt_module]['DELETE']."' title='".$lang_new[$pnt_module]['DELETE']."'></a>";
