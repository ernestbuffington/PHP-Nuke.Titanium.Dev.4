...
{
	$delmarksquery = "delete from ".$network_prefix."_bookmarks where category_id=$catid AND user_id=$userid";
	$delcatquery   = "delete from ".$network_prefix."_bookmarks_cat where category_id=$catid AND user_id=$userid";
