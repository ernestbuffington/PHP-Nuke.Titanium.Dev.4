...
{
	$delmarksquery = "delete from ".$network_prefix."_bookmarks where id=$markid AND user_id=$userid";	
	$db->sql_query ($delmarksquery,$db);
	$updatecatquery = "update ".$network_prefix."_bookmarks_cat set mod_date=now() where category_id=$catid";
