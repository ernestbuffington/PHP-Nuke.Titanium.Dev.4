...
<!-- BEGIN limit_row -->
    <tr> 
      ...
      <tr>
        <td class="row1" align="center" valign="middle" width="10%" wrap="nowrap"><strong><span class="gensmall"><a href="{limit_row.U_VIEW}" class="gensmall">{L_VIEW}</a></span></strong></td>
