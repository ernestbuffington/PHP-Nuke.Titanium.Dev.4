...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
    ...
    <tr> 
      <td class="row1" align="right"><strong>{L_RECIPIENTS}</strong></td>
      <td class="row2" align="left">{S_GROUP_SELECT}</td>
    </tr>
    <tr> 
      <td class="row1" align="right"><strong>{L_EMAIL_SUBJECT}</strong></td>
    ...
    <tr> 
      <td class="row1" align="right" valign="top"> <span class="gen"><strong>{L_EMAIL_MSG}</strong></span> 
