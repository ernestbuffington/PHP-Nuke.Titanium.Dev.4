...
<form method="post" action="{S_SMILEY_ACTION}"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
    ...
    <!-- END smiles -->
    <tr>
        <td class="catBottom" colspan="5" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="add" value="{L_SMILEY_ADD}" class="mainoption" />&nbsp;&nbsp;<input class="titaniumbutton" type="submit" name="import_pack" value="{L_IMPORT_PACK}">&nbsp;&nbsp;<input class="titaniumbutton" type="submit" name="export_pack" value="{L_EXPORT_PACK}"></td>
    </tr>
</table></form>