...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    ...
    <td class="row2"><strong>{NUMBER_OF_ATTACHMENTS}</strong></td>
  </tr>
  <tr> 
    <td class="row1" nowrap="nowrap">{L_TOTAL_FILESIZE}:</td>
    <td class="row2"><strong>{TOTAL_FILESIZE}</strong></td>
  </tr>
  <tr> 
    <td class="row1" nowrap="nowrap">{L_ATTACH_QUOTA}:</td>
    <td class="row2"><strong>{ATTACH_QUOTA}</strong></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td class="row2"><strong>{NUMBER_OF_PMS}</strong></td>
  </tr>
  <tr> 
