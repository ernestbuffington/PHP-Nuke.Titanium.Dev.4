...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <tr>
        <td class="catLeft" width="50%"><span class="gen"><input type="text" class="post" size="20" name="new_language" />&nbsp;<input type="submit" name="new_lang_submit" value="{L_CREATE_NEW_LANG}" class="titaniumbutton" /></span></td> <!-- create new language, possible to choose an existing language as schema -->
    ...
    <tr>
        ...
        <td class="row2" align="center" valign="middle"><span class="gen"><input type="submit" name="delete_complete_lang[{langrow.LANGUAGE}]" value="{L_DELETE_LANG}" class="titaniumbutton" /></span></td> <!-- Delete language for all modules -->
