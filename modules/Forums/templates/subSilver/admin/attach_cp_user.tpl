...
<!--      <td align="left" nowrap="nowrap"><span class="gen"><a class="gen" href="{U_BACK}" />Back</a></span></td> -->
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
    ...
    <tr> 
      ...
      <td class="{memberrow.ROW_CLASS}" align="center" valign="middle">&nbsp;<strong>{memberrow.TOTAL_ATTACHMENTS}</strong>&nbsp;</td>
      <td class="{memberrow.ROW_CLASS}" align="center">&nbsp;<strong>{memberrow.TOTAL_SIZE}</strong>&nbsp;</td>
    </tr>
    <!-- END memberrow -->
    <tr> 
