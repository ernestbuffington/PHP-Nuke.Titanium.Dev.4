...
$look_in_themes_dir_for_forum_icons_view_forum = img($forum_row['forum_icon'], 'Forums');   
...
$phpbb2_template->assign_vars(array(
		...
		'FORUM_ICON_IMG' => ($forum_row['forum_icon']) ? '<img src="'.$look_in_themes_dir_for_forum_icons_view_forum.'" 
