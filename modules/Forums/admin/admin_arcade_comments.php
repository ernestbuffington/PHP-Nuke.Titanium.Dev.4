...
$mode = $HTTP_GET_VARS['mode'];
    ...
    $phpbb2_template->assign_vars(array(
            ...
            'S_ACTION' => append_titanium_sid('admin_arcade_comments.' . $phpEx . '?mode=update'), 
            ));
 ...
 ******************************************************/
                 'USERNAME' => '<a href="../../../' . append_titanium_sid("statarcade.$phpEx?uid=" . $row['user_id'] ) . '" class="genmed">' . UsernameColor($row['username']) . '</a> ',
/*****[END]********************************************
 [ Mod:    Advanced Username Color             v1.0.5 ]
 ******************************************************/
                 'EDIT_COMMENTS' => '<a href="' . append_titanium_sid("admin_arcade_comments.$phpEx?mode=edit&amp;gid=" . $row['game_id']) . '">Edit Comment</a>',
            )); 
