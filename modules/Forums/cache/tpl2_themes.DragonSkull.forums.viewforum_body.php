...
// eXtreme Styles mod cache. Generated on Tue, 23 Mar 2021 05:26:07 +0000 (time=1616477167)
...
?>
  <tr> 
	...
	<td class="row1" width="100%" height="50"><a href="<?php echo isset($forumrow_item['U_VIEWFORUM']) ? $forumrow_item['U_VIEWFORUM'] : ''; ?>" <?php if ($forumrow_item['UNREAD']) {  ?>class="topic-new"<?php } ?>><?php echo isset($forumrow_item['FORUM_NAME']) ? $forumrow_item['FORUM_NAME'] : ''; ?></a><br /><?php echo isset($forumrow_item['FORUM_DESC']) ? $forumrow_item['FORUM_DESC'] : ''; ?></td>
...
<table width="100%" cellspacing="0" border="0" align="center" cellpadding="0">
    <tr>
        ...
        <td width="20" align="left"><img src="<?php echo isset($this->vars['FOLDER_NEW_IMG']) ? $this->vars['FOLDER_NEW_IMG'] : $this->lang('FOLDER_NEW_IMG'); ?>" alt="<?php echo isset($this->vars['L_NEW_POSTS']) ? $this->vars['L_NEW_POSTS'] : $this->lang('L_NEW_POSTS'); ?>" /></td>
          ...
          <td><?php echo isset($this->vars['L_GLOBAL_ANNOUNCEMENT']) ? $this->vars['L_GLOBAL_ANNOUNCEMENT'] : $this->lang('L_GLOBAL_ANNOUNCEMENT'); ?></td>
        ...
        <tr>
          ...
          <td><?php echo isset($this->vars['L_NEW_POSTS_HOT']) ? $this->vars['L_NEW_POSTS_HOT'] : $this->lang('L_NEW_POSTS_HOT'); ?></td>
          <td>&nbsp;&nbsp;</td>
          ...
          <td><?php echo isset($this->vars['L_NO_NEW_POSTS_HOT']) ? $this->vars['L_NO_NEW_POSTS_HOT'] : $this->lang('L_NO_NEW_POSTS_HOT'); ?></td>
          <td>&nbsp;&nbsp;</td>
          <!-- Start replacement - Global announcement MOD -->
          ...
          <td><?php echo isset($this->vars['L_ANNOUNCEMENT']) ? $this->vars['L_ANNOUNCEMENT'] : $this->lang('L_ANNOUNCEMENT'); ?></td>
          <!-- End replacement - Global announcement MOD -->
        </tr>
        <tr>
          ...
          <td><?php echo isset($this->vars['L_STICKY']) ? $this->vars['L_STICKY'] : $this->lang('L_STICKY'); ?></td>
