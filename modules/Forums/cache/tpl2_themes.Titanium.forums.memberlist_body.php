...
// eXtreme Styles mod cache. Generated on Mon, 12 Apr 2021 14:14:37 +0000 (time=1618236877)
...
<table style="width: 100%;" border="0" cellpadding="4" cellspacing="1" class="forumline">
  <tr>
    <td class="catHead">
      <table style="width: 100%;" border="0" cellpadding="4" cellspacing="1" class="forumline">
        <tr>
          <td class="row1" style="text-align: center; width: 33.3%;"><?php echo isset($this->vars['L_SELECT_SORT_METHOD']) ? $this->vars['L_SELECT_SORT_METHOD'] : $this->lang('L_SELECT_SORT_METHOD'); ?>&nbsp;<?php echo isset($this->vars['S_MODE_SELECT']) ? $this->vars['S_MODE_SELECT'] : $this->lang('S_MODE_SELECT'); ?>&nbsp;<?php echo isset($this->vars['S_ORDER_SELECT']) ? $this->vars['S_ORDER_SELECT'] : $this->lang('S_ORDER_SELECT'); ?>&nbsp;<input type="submit" name="submit" value="<?php echo isset($this->vars['L_GO']) ? $this->vars['L_GO'] : $this->lang('L_GO'); ?>" style="cursor: pointer;" class="liteoption" /></td>
          <td class="catHead" style="text-align: center; width: 33.3%;"><?php echo isset($this->vars['L_PAGE_TITLE']) ? $this->vars['L_PAGE_TITLE'] : $this->lang('L_PAGE_TITLE'); ?></td>
          <td class="row1" style="width: 33.3%;">
          <span>
            <span class="tooltip icon-sprite icon-info" style="float: left; margin-top: 2px;" title="<?php echo isset($this->vars['U_SEARCH_EXPLAIN']) ? $this->vars['U_SEARCH_EXPLAIN'] : $this->lang('U_SEARCH_EXPLAIN'); ?>"></span><input type="text" class="post" name="username" maxlength="25" size="20" tabindex="1" value="" />&nbsp;<input type="submit" name="submituser" value="<?php echo isset($this->vars['L_LOOK_UP']) ? $this->vars['L_LOOK_UP'] : $this->lang('L_LOOK_UP'); ?>" style="cursor: pointer;" class="myButton" /></td>
          </span>
        </tr>
      </table>
    </td>
          ...
          <td valign="top">
            <table style="width:100%;" border="0" cellpadding="0" cellspacing="1" class="forumline">
              <tr>
                ...
                <td class="catHead acenter" style="width: 25%;"><?php echo isset($this->vars['L_USERNAME']) ? $this->vars['L_USERNAME'] : $this->lang('L_USERNAME'); ?></td>
                <td class="catHead acenter" style="width: 25%;"><?php echo isset($this->vars['L_FROM']) ? $this->vars['L_FROM'] : $this->lang('L_FROM'); ?></td>
                <td class="catHead acenter" style="width: 5%;"><?php echo isset($this->vars['L_AGE']) ? $this->vars['L_AGE'] : $this->lang('L_AGE'); ?></td>                
                <td class="catHead acenter" style="width: 10%;"><?php echo isset($this->vars['L_POSTS']) ? $this->vars['L_POSTS'] : $this->lang('L_POSTS'); ?></td>
                <td class="catHead acenter" style="width: 10%;"><?php echo isset($this->vars['L_JOINED']) ? $this->vars['L_JOINED'] : $this->lang('L_JOINED'); ?></td>
                <td class="catHead acenter" style="width: 10%;"><?php echo isset($this->vars['L_LAST_VISIT']) ? $this->vars['L_LAST_VISIT'] : $this->lang('L_LAST_VISIT'); ?></td>
                <td class="catHead acenter" style="width: 10%;"><?php echo isset($this->vars['L_ONLINE_STATUS']) ? $this->vars['L_ONLINE_STATUS'] : $this->lang('L_ONLINE_STATUS'); ?></td>
              </tr>
              <?php
...
?>
              <tr> 
                <td class="row1" colspan="8" style="text-align: center; text-transform: uppercase;"><?php echo isset($no_username_item['NO_USER_ID_SPECIFIED']) ? $no_username_item['NO_USER_ID_SPECIFIED'] : ''; ?></td>
              </tr>
              <?php
...
?>
              <tr>
                ...
                <td class="<?php echo isset($memberrow_item['ROW_CLASS']) ? $memberrow_item['ROW_CLASS'] : ''; ?>">
                  ...
                  <span style="float: right;"><?php echo isset($memberrow_item['GENDER']) ? $memberrow_item['GENDER'] : ''; ?><?php echo isset($memberrow_item['WWW']) ? $memberrow_item['WWW'] : ''; ?><?php echo isset($memberrow_item['FACEBOOK']) ? $memberrow_item['FACEBOOK'] : ''; ?><?php echo isset($memberrow_item['PM']) ? $memberrow_item['PM'] : ''; ?></span>
                </td>
...
?>
  ...
  <tr>       
    <td class="catBottom" style="font-size: 13px; text-align: right;"><?php
...
?> <?php if ($pagination_item['TOTAL'] < $pagination_item['PERPAGE']) {  ?><?php } else { ?><?php echo isset($pagination_item['PAGINATION']) ? $pagination_item['PAGINATION'] : ''; ?><?php } ?><?php
