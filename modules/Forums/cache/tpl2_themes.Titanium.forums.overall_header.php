...
// eXtreme Styles mod cache. Generated on Mon, 12 Apr 2021 14:14:24 +0000 (time=1618236864)
...
<table style="margin: auto; width: 680px; table-layout: fixed;" cellpadding="1" cellspacing="4" border="0">
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_MINI_INDEX']) ? $this->vars['L_MINI_INDEX'] : $this->lang('L_MINI_INDEX'); ?></strong></a>
    </td>    
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_MEMBERLIST']) ? $this->vars['U_MEMBERLIST'] : $this->lang('U_MEMBERLIST'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_MEMBERLIST']) ? $this->vars['L_MEMBERLIST'] : $this->lang('L_MEMBERLIST'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_SEARCH']) ? $this->vars['U_SEARCH'] : $this->lang('U_SEARCH'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_SEARCH']) ? $this->vars['L_SEARCH'] : $this->lang('L_SEARCH'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_GROUP_CP']) ? $this->vars['U_GROUP_CP'] : $this->lang('U_GROUP_CP'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_USERGROUPS']) ? $this->vars['L_USERGROUPS'] : $this->lang('L_USERGROUPS'); ?></strong></a>
    </td>    
  </tr>
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="<?php echo isset($this->vars['U_RANKS']) ? $this->vars['U_RANKS'] : $this->lang('U_RANKS'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_RANKS']) ? $this->vars['L_RANKS'] : $this->lang('L_RANKS'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_STAFF']) ? $this->vars['U_STAFF'] : $this->lang('U_STAFF'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_STAFF']) ? $this->vars['L_STAFF'] : $this->lang('L_STAFF'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_STATISTICS']) ? $this->vars['U_STATISTICS'] : $this->lang('U_STATISTICS'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_STATISTICS']) ? $this->vars['L_STATISTICS'] : $this->lang('L_STATISTICS'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_FAQ']) ? $this->vars['U_FAQ'] : $this->lang('U_FAQ'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_FAQ']) ? $this->vars['L_FAQ'] : $this->lang('L_FAQ'); ?></strong></a>
    </td>
  </tr>
  ...
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="<?php echo isset($this->vars['U_RULES']) ? $this->vars['U_RULES'] : $this->lang('U_RULES'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_RULES']) ? $this->vars['L_RULES'] : $this->lang('L_RULES'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_PROFILE']) ? $this->vars['U_PROFILE'] : $this->lang('U_PROFILE'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_PROFILE']) ? $this->vars['L_PROFILE'] : $this->lang('L_PROFILE'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_PRIVATEMSGS']) ? $this->vars['U_PRIVATEMSGS'] : $this->lang('U_PRIVATEMSGS'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['PRIVATE_MESSAGE_INFO']) ? $this->vars['PRIVATE_MESSAGE_INFO'] : $this->lang('PRIVATE_MESSAGE_INFO'); ?></strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
        ...
        <a href="<?php echo isset($this->vars['U_LOGIN_LOGOUT']) ? $this->vars['U_LOGIN_LOGOUT'] : $this->lang('U_LOGIN_LOGOUT'); ?>" class="mainmenu"><strong><?php echo isset($this->vars['L_LOGIN_LOGOUT']) ? $this->vars['L_LOGIN_LOGOUT'] : $this->lang('L_LOGIN_LOGOUT'); ?></strong></a>
    </td>
  </tr>
</table>
...
<table border="0" cellpadding="4" cellspacing="1" class="wtf col-12">
  <tr>
    <td align="center"><?php echo isset($switch_quick_search_item['L_QUICK_SEARCH_FOR']) ? $switch_quick_search_item['L_QUICK_SEARCH_FOR'] : ''; ?> <input class="post" type="text" name="search_keywords" size="15" /> <?php echo isset($switch_quick_search_item['L_QUICK_SEARCH_AT']) ? $switch_quick_search_item['L_QUICK_SEARCH_AT'] : ''; ?> 
        ...
        <input class="myButton" type="submit" value="<?php echo isset($this->vars['L_SEARCH']) ? $this->vars['L_SEARCH'] : $this->lang('L_SEARCH'); ?>" />
    </td>
  </tr>
</table>
</form>
