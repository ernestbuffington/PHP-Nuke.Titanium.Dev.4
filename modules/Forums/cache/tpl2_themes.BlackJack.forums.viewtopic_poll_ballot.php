...
// eXtreme Styles mod cache. Generated on Thu, 29 Dec 2022 19:56:27 +0000 (time=1672343787)
...
?>
        ...
        <tr>
          <td><input type="submit" name="submit" value="<?php echo isset($this->vars['L_SUBMIT_VOTE']) ? $this->vars['L_SUBMIT_VOTE'] : $this->lang('L_SUBMIT_VOTE'); ?>" class="titaniumbutton" /></td>
        </tr>
        <tr>                        
