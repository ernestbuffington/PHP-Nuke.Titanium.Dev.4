...
// eXtreme Styles mod cache. Generated on Thu, 29 Dec 2022 04:44:05 +0000 (time=1672289045)
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
    ...
    <tr> 
      <td class="catBottom" align="center" valign="middle" colspan="6" height="28"><span class="genmed"><?php echo isset($this->vars['L_CATEGORY']) ? $this->vars['L_CATEGORY'] : $this->lang('L_CATEGORY'); ?>:&nbsp;<?php echo isset($this->vars['S_CATEGORY_SELECT']) ? $this->vars['S_CATEGORY_SELECT'] : $this->lang('S_CATEGORY_SELECT'); ?>&nbsp;<input type="submit" class="titaniumbutton" value="<?php echo isset($this->vars['L_GO']) ? $this->vars['L_GO'] : $this->lang('L_GO'); ?>" name="avatargallery" /></span></td>
    </tr>
    <?php
...
?>
        <td class="row1" align="center"><img class="rounded-corners-user-info" style="max-width: 150px;" src="<?php echo isset($avatar_column_item['AVATAR_IMAGE']) ? $avatar_column_item['AVATAR_IMAGE'] : ''; ?>" alt="<?php echo isset($avatar_column_item['AVATAR_NAME']) ? $avatar_column_item['AVATAR_NAME'] : ''; ?>" title="<?php echo isset($avatar_column_item['AVATAR_NAME']) ? $avatar_column_item['AVATAR_NAME'] : ''; ?>" /></td>
    <?php
...
?>
    <tr> 
      <td class="catBottom" colspan="<?php echo isset($this->vars['S_COLSPAN']) ? $this->vars['S_COLSPAN'] : $this->lang('S_COLSPAN'); ?>" align="center" height="28"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?> 
        ...
        &nbsp;&nbsp; 
        <input type="submit" name="cancelavatar" value="<?php echo isset($this->vars['L_RETURN_PROFILE']) ? $this->vars['L_RETURN_PROFILE'] : $this->lang('L_RETURN_PROFILE'); ?>" class="titaniumbutton" />
      </td>
    </tr>
  </table>
</form>