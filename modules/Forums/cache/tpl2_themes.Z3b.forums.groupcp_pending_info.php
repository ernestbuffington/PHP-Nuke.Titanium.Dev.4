...
// eXtreme Styles mod cache. Generated on Sun, 25 Apr 2021 00:21:20 +0000 (time=1619310080)
...
?>
    <tr> 
      ...
      <td class="<?php echo isset($pending_members_row_item['ROW_CLASS']) ? $pending_members_row_item['ROW_CLASS'] : ''; ?>" align="center"><span class="gen"><a href="<?php echo isset($pending_members_row_item['U_VIEWPROFILE']) ? $pending_members_row_item['U_VIEWPROFILE'] : ''; ?>" class="gen"><?php echo isset($pending_members_row_item['USERNAME']) ? $pending_members_row_item['USERNAME'] : ''; ?></a></span></td>
      ...
      <td class="<?php echo isset($pending_members_row_item['ROW_CLASS']) ? $pending_members_row_item['ROW_CLASS'] : ''; ?>" align="center" valign="middle">
        <table border="0">
          <tr>
            <td align="center" width="90%"><span class="gen"><?php echo isset($pending_members_row_item['FROM']) ? $pending_members_row_item['FROM'] : ''; ?></span></td>
            <td align="right"><?php echo isset($pending_members_row_item['FLAG']) ? $pending_members_row_item['FLAG'] : ''; ?></td>
          </tr>
        </table>
      </td>
...
?>
    <tr> 
      <td class="cat" colspan="9" align="right"><span class="cattitle"> 
        <input type="submit" name="approve" value="<?php echo isset($this->vars['L_APPROVE_SELECTED']) ? $this->vars['L_APPROVE_SELECTED'] : $this->lang('L_APPROVE_SELECTED'); ?>" class="mainoption" />
        &nbsp; 
        <input type="submit" name="deny" value="<?php echo isset($this->vars['L_DENY_SELECTED']) ? $this->vars['L_DENY_SELECTED'] : $this->lang('L_DENY_SELECTED'); ?>" class="liteoption" />
        </span></td>
    </tr>
</table>