...
//
$userdata = titanium_session_pagestart($pnt_user_ip, PAGE_SCOREBOARD, $nukeuser);
...
if (!($score_row = $pnt_db->sql_fetchrow($result))) {
 ...
 ******************************************************/
                $pnt_user_gc = UsernameColor($score_rowset[$i]['username']);
/*****[END]********************************************
 [ Mod:    Advanced Username Color             v1.0.5 ]
 ******************************************************/
