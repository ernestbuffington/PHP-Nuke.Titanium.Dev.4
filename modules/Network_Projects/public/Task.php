...
echo "<td width='100%' colspan='4'><nobr><a href='modules.php?name=$titanium_module_name&amp;op=Project&amp;project_id=".$task['project_id']."'>".$project['project_name']."</a></nobr></td></tr>\n";
...
if($task['date_started'] > 0){
  $phpbb2_start_date = date($pj_config['task_date_format'], $task['date_started']);
  $pjimage = pjimage("date.png", $titanium_module_name);
  echo "<tr><td align='center'><img src='$pjimage'></td>\n";
  echo "<td width='100%' colspan='4'><nobr>"._NETWORK_STARTDATE.": <strong>$phpbb2_start_date</strong></nobr></td></tr>\n";
}
