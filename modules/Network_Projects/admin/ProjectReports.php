...
$pagetitle = _NETWORK_TITLE.' v'.$pj_config['version_number'].' - '._NETWORK_PROJECTS.': '._NETWORK_REPORTLIST;
...
//echo "<br />\n";
$reportresult = $titanium_db2->sql_query("SELECT `report_id`, `report_name`, `type_id`, `status_id` FROM `".$network_prefix."_reports` WHERE `project_id`='$project_id' ORDER BY `report_name`");
