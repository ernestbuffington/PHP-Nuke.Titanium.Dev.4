...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var array
     */
    private $phpbb2_template_dir = array();
    /**
     ...
     * @var array
     */
    public $phpbb2_template_functions = array();
    /**
     ...
     * @var array
     */
    public $phpbb2_template_objects = array();
    /**
     ...
     *
     * @param  string|array $phpbb2_template_dir directory(s) of template sources
     * @return Smarty       current Smarty instance for chaining
     */
    public function setTemplateDir($phpbb2_template_dir)
    {
        $this->template_dir = array();
        foreach ((array) $phpbb2_template_dir as $k => $v) {
     ...
     */
    public function addTemplateDir($phpbb2_template_dir, $key=null)
    {
        // make sure we're dealing with an array
        $this->template_dir = (array) $this->template_dir;

        if (is_array($phpbb2_template_dir)) {
            foreach ($phpbb2_template_dir as $k => $v) {
                if (is_int($k)) {
            ...
            $this->template_dir[$key] = rtrim($phpbb2_template_dir, '/\\') . DS;
        } else {
            // append new directory
            $this->template_dir[] = rtrim($phpbb2_template_dir, '/\\') . DS;
        }
        $this->joined_template_dir = join(DIRECTORY_SEPARATOR, $this->template_dir);
     ...
     *
     * @param  string|array $phpbb2_template_dir directory(s) of configuration sources
     * @return Smarty       current Smarty instance for chaining
     */
     ...
     */
    public function getTags(Smarty_Internal_Template $phpbb2_template)
    {
        return Smarty_Internal_Utility::getTags($phpbb2_template);
    }
