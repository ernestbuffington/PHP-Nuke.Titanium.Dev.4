 ...
 *      - current implementation of isTrustedResourceDir() assumes that Smarty::$phpbb2_template_dir and Smarty::$config_dir are immutable
 *        the cache is killed every time either of the variables change. That means that two distinct Smarty objects with differing
 *        $phpbb2_template_dir or $config_dir should NOT share the same Smarty_Security instance,
...
class Smarty_Security
{
     ...
     * $phpbb2_template_dir is in this list implicitly.
     *
     * @var array
     */
    ...
    /**
     * Cache for $phpbb2_template_dir lookups
     * @var array
     */
