...
abstract class Smarty_Resource
{
     ...
     * @var string
     */
    public $phpbb2_template_lexer_class = 'Smarty_Internal_Templatelexer';

    /**
     * Name of the Class to parse this resource's contents with
     * @var string
     */
    public $phpbb2_template_parser_class = 'Smarty_Internal_Templateparser';
     ...
     * @param  string $phpbb2_template_resource template_resource to extracate resource handler and name of
     * @return string unique resource name
     */
    public static function getUniqueTemplateName($smarty, $phpbb2_template_resource)
    {
        self::parseResourceName($phpbb2_template_resource, $smarty->default_resource_type, $name, $type);
     ...
     *
     * Either [$_template] or [$smarty, $phpbb2_template_resource] must be specified
     *
     * @param  Smarty_Internal_Template $_template         template object
     * @param  Smarty                   $smarty            smarty object
     * @param  string                   $phpbb2_template_resource resource identifier
     * @return Smarty_Template_Source   Source Object
     */
    public static function source(Smarty_Internal_Template $_template=null, Smarty $smarty=null, $phpbb2_template_resource=null)
    {
        if ($_template) {
            $smarty = $_template->smarty;
            $phpbb2_template_resource = $_template->template_resource;
        }
        ...
        // create source
        $source = new Smarty_Template_Source($resource, $smarty, $phpbb2_template_resource, $type, $name, $unique_resource_name);
 ...
 * @property boolean $phpbb2_template  Extended Template reference
...
class Smarty_Template_Source
{
     ...
     * @var string
     */
    public $phpbb2_template_lexer_class = null;

    /**
     * Name of the Class to parse this resource's contents with
     * @var string
     */
    public $phpbb2_template_parser_class = null;
    ...
    /**
     * Template Resource (Smarty_Internal_Template::$phpbb2_template_resource)
     * @var string
     */
