...
if(getAnswerRating($_GET['answer'], $userid) == false){
	createAnswerRating($_GET['answer'], $userid, $_GET['upvote'] == "true");
}else{
	updateAnswerRating($_GET['answer'], $userid, $_GET['upvote'] == "true");
}
