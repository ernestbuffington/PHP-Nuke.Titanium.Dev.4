...
$priorityresult = $titanium_db2->sql_query("SELECT `priority_id`, `priority_weight` FROM `".$network_prefix."_projects_priorities` WHERE `priority_weight`>='".$priority['priority_weight']."'");
