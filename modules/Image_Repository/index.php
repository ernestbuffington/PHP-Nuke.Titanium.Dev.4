...
//-------------------------------------------------------------------------
if(file_exists(NUKE_MODULES_DIR.$pnt_module.'/language/lang-'.$userinfo['user_lang'].'.php'))
	include_once(NUKE_MODULES_DIR.$pnt_module.'/language/lang-'.$userinfo['user_lang'].'.php');
else
