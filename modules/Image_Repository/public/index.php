...
function main()
{
	global $titanium_db, $titanium_lang_new, $titanium_module_name, $userinfo, $nukeurl, $settings, $mysettings, $myimages;
	OpenTable();
	echo '<br />';
...
//-------------------------------------------------------------------------	
	...
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catHead',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['UPLOAD']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr>'."\n";
	echo '    <td'.tablecss('50%',FALSE,'catBottom').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['BROWSE']).'</td>'."\n";
	echo '    <td'.tablecss('50%',FALSE,'catBottom').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['PROGRESS']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr>'."\n";
	...
	echo '  </tr>'."\n";
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catBottom',2).'>'.submitbuttoncss(FALSE,$titanium_lang_new[$titanium_module_name]['SUBMIT']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '</table>'."\n";	
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------	
	...
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catHead',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['ATTENTION']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','row1',2).'>'._string_to_upper(sprintf($titanium_lang_new[$titanium_module_name]['QUOTA_REACHED'],UsernameColor($userinfo['username']))).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr>'."\n";
...
//-------------------------------------------------------------------------	
	...
	echo '    <td'.tablecss(FALSE,'center','catBottom',2).' id="errortable_header">'._string_to_upper($titanium_lang_new[$titanium_module_name]['MYIMAGES']).'</td>'."\n";
	echo '  </tr>'."\n";
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------	
	...
	echo '    <td'.tablecss(FALSE,'center','row1',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['IMAGE_NONE']).'</td>'."\n";
	echo '  </tr>'."\n";
//-------------------------------------------------------------------------
//	SHOW THAT NO IMAGES CURRENTLY EXIST IN THEIR DATABASE.
//-------------------------------------------------------------------------	
	echo '  <tr id="imagelist" '.(($titanium_db->sql_numrows($result) == 0) ? 'style="display:none;"' : '').'>'."\n";
	echo '    <td'.tablecss('15%','center','catBottom').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['IMAGE']).'</td>'."\n";
	echo '    <td'.tablecss('85%','center','catBottom').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['CODES']).'</td>'."\n";
	echo '  </tr>'."\n";	
...
//-------------------------------------------------------------------------		
			...
			{
				echo '    <td'.tablecss(FALSE,'center','row1').' id="thumbnail_holder'.$row['pid'].'"><a'.linkcss().' data-id="'.$row['pid'].'" class="generate-thumbnail" href="">'.$titanium_lang_new[$titanium_module_name]['GENERATE'].'</a></td>'."\n";
			}
//-------------------------------------------------------------------------
//	CHECK TO MAKE SURE A THUMBNAIL EXISTS, IF IT DOES NOT, MAKE ONE.
//-------------------------------------------------------------------------	
...
//-------------------------------------------------------------------------	
			...
			echo '        <tr>'."\n";
			echo '          <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['DIRECT'].'</td>';
			...
			echo '        </tr>'."\n".'<tr>'."\n";
			echo '          <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['BBCODE'].'</td>';
			...
			echo '        </tr>'."\n".'<tr>'."\n";
			echo '          <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['OPTIONS'].'</td>';
			echo '          <td'.tablecss('80%','left','row1').'>';		
			// echo '            <a'.linkcss().' data-id="'.$row['pid'].'" class="code-popup" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['CODES_PLUS'].'</a> | ';
			echo '            <a'.linkcss().get_image_viewer('myimages').' href="'._IREPOSITORY_DIR._IREPOSITORY_USER_FOLDER.'/'.$row['filename'].'">'.$titanium_lang_new[$titanium_module_name]['FULL'].'</a> | ';
			echo '            <a'.linkcss().' data-id="'.$row['pid'].':::'.$row['size'].'" class="delete-image" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['DELETE'].'</a>';
			echo '          </td>';
			echo '        </tr>'."\n";
			echo '      </table>'."\n";
			echo '    </td>'."\n";			
...
//-------------------------------------------------------------------------
	if($myimages > $settings['perpage'])
	{
		if ($pagination->getCurrent() == 1)
			$first = ' | <span>'.$titanium_lang_new[$titanium_module_name]['FIRST'].'</span> | ';
		else
			$first = ' | <a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;page='.$pagination->getFirst().'">'.$titanium_lang_new[$titanium_module_name]['FIRST'].'</a> |';
			
		if ($pagination->getPrevious())
			$prev = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;page='.$pagination->getPrevious().'">'.$titanium_lang_new[$titanium_module_name]['PREVIOUS'].'</a> | ';
		else
			$prev = $titanium_lang_new[$titanium_module_name]['PREVIOUS'].' | ';
			
		if ($pagination->getNext())
			$next = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;page='.$pagination->getNext().'">'.$titanium_lang_new[$titanium_module_name]['NEXT'].'</a> | ';
		else
			$next = $titanium_lang_new[$titanium_module_name]['NEXT'].' | ';
			
		if ($pagination->getLast())
			$last = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;page='.$pagination->getLast().'">'.$titanium_lang_new[$titanium_module_name]['LAST'].'</a>';
		else
			$last = $titanium_lang_new[$titanium_module_name]['LAST'];
			
		echo $pagination->getFirstOf().' '.$titanium_lang_new[$titanium_module_name]['TO'].' '.$pagination->getSecondOf().' '.$titanium_lang_new[$titanium_module_name]['OF'].' <span class="pagination_total">'.$pagination->getTotalItems().'</span> '.$first . " " . $prev . " " . $next . " " . $last;
//-------------------------------------------------------------------------
//	PAGINATION LINKS
//-------------------------------------------------------------------------
	}
...
{
	global $titanium_db, $titanium_lang_new, $titanium_module_name, $userinfo, $settings;
//-------------------------------------------------------------------------
//	CHECK IF IT'S AN AJAX REQUEST, EXIT IF NOT.
//-------------------------------------------------------------------------
    if(!isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) != 'xmlhttprequest')
        die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['NEXT_TIME'])));
//-------------------------------------------------------------------------
//	CHECK IF IT'S AN AJAX REQUEST, EXIT IF NOT.
//-------------------------------------------------------------------------
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
    ...
    {
    	die(json_encode(array('error' => sprintf($titanium_lang_new[$titanium_module_name]['QUOTA_REACHED'],$userinfo['username']))));
    }
//-------------------------------------------------------------------------
//	ALERT THE USER, IF THEY HAVE REACHED THEIR ALLOTTED QUOTA.
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
	...
	switch(strtolower($image_size_info['mime']))
	{
		...
		case 'image/pjpeg':
			break;
		default:
			die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['SUPPORTED'])));
	}
//-------------------------------------------------------------------------
//	DO A QUICK CHECK TO MAKE SURE THE FILE BE UPLOADED IS AN IMAGE.
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
	if($_FILES['myimage']['size'] > $settings['max_upload'])
		die(json_encode(array('error' => sprintf($titanium_lang_new[$titanium_module_name]['IMAGE_SIZE_ERROR'],_calculate_size($settings['max_upload'])))));
//-------------------------------------------------------------------------
//	MAKE SURE THE IMAGE DOES NOT EXCEED THE SPECIFIED MAX SIZE IN ADMIN.
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
		die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['SOMETHING_WRONG'])));
//-------------------------------------------------------------------------
//	THROW OUT AN ERROR, IF SOMETHING HAS GONE WRONG.
//-------------------------------------------------------------------------
	}
...
{
	global $titanium_db, $titanium_lang_new, $titanium_module_name, $userinfo;
...
//-------------------------------------------------------------------------
	if($row['submitter'] == $userinfo['user_id'])
		die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['NEXT_TIME_OWNER'])));
//-------------------------------------------------------------------------
//	CHECK WHOEVER IS TRYING TO GENERATE THUMB, OWNS THE IMAGE
//-------------------------------------------------------------------------	
...
//-------------------------------------------------------------------------	
		if(_createthumb(_IREPOSITORY_DIR._IREPOSITORY_USER_FOLDER.'/'.$row['filename'], _IREPOSITORY_DIR._IREPOSITORY_USER_FOLDER_THUMBS.'/thumb_'.$row['filename'], array('width' => _IREPOSITORY_THUMBWIDTH, 'height' => _IREPOSITORY_THUMBHEIGHT, 'aspect_ratio' => TRUE)))
			...
			die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['SOMETHING_WRONG_THUMB'])));
//-------------------------------------------------------------------------
//	IF THE UPLOADED IMAGE, EXCEEDS THE SPECIFIED THUMBNAIL SIZE,
//	GENERATE A THUMBNAIL, THIS WILL GREATLY IMPROVE ON PAGE LOAD TIMES.
//-------------------------------------------------------------------------	
...
{
	global $titanium_db, $titanium_lang_new, $titanium_module_name, $userinfo, $nukeurl;
	...
	echo '	<tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catHead',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['EXTRA_CODES']).'</td>'."\n";
	echo '  </tr>'."\n";
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------	
	echo '	<tr>'."\n";
	echo '    <td'.tablecss(FALSE,FALSE,'catHead',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['CODES']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['DIRECT'].'</td>'."\n";
	echo '	  <td'.tablecss('80%',FALSE,'row1').'>'.inputfield('direct','text',FALSE,'98%',FALSE,$nukeurl.'/'._IREPOSITORY_DIR._IREPOSITORY_USER_FOLDER.'/'.$row['filename'],FALSE,TRUE,FALSE,FALSE,TRUE).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	...
	echo '	  <td'.tablecss('80%',FALSE,'row1').'>'.inputfield('bbcode','text',FALSE,'98%',FALSE,'[img]'.$nukeurl.'/'._IREPOSITORY_DIR._IREPOSITORY_USER_FOLDER.'/'.$row['filename'].'[/img]',FALSE,TRUE,FALSE,FALSE,TRUE).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['HTML'].'</td>'."\n";
	...
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '    <td'.tablecss(FALSE,FALSE,'catHead',2).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['CODES_THUMBS']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss('20%','right','row1').'>'.$titanium_lang_new[$titanium_module_name]['DIRECT'].'</td>'."\n";
...
function mysettings()
{
	global $titanium_db, $titanium_lang_new, $titanium_module_name, $userinfo, $settings, $mysettings;
...
//	UPDATE THE ADMINISTRATION SETTINGS, ONLY ADMINS CAN DO THIS.
//-------------------------------------------------------------------------
		_redirect_titanium('modules.php?name='.$titanium_module_name.'&op=settings');
	}

	OpenTable();
	index_navigation_header();
	echo '<form action="modules.php?name='.$titanium_module_name.'&amp;op=settings" method="post">'."\n";
	echo '<table style="width:100%;" border="0" cellpadding="4" cellspacing="1" class="forumline">'."\n";
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catHead',3).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['SETTINGS_CONFIGURE']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss(FALSE,FALSE,'catHead',3).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['PROGRESS_BAR']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss('33.333%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['BORDER']).'</td>'."\n";
	echo '	  <td'.tablecss('33.333%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['BACKGROUND']).'</td>'."\n";
	echo '	  <td'.tablecss('33.333%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['PERCENTAGE']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	...
	echo '      <a data-id="0" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-0'].'</a>&nbsp;|&nbsp;';
	echo '      <a data-id="5" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-5'].'</a>&nbsp;|&nbsp;';
	echo '      <a data-id="25" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-25'].'</a>&nbsp;|&nbsp;';
	echo '      <a data-id="50" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-50'].'</a>&nbsp;|&nbsp;';
	echo '      <a data-id="75" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-75'].'</a>&nbsp;|&nbsp;';
	echo '      <a data-id="100" class="percentage" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['PERCENTAGE-100'].'</a>';
	echo '    </td>';
	echo '  </tr>'."\n";
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
	...
	{
		echo '  <tr>'."\n";
		echo '    <td'.tablecss(FALSE,'center','catHead',3).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['ADMINISTRATION']).'</td>'."\n";
		echo '  </tr>'."\n".'<tr>'."\n";
		...
		echo '        </tr>'."\n".'<tr>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.$titanium_lang_new[$titanium_module_name]['QUOTA_DEFAULT'].'</td>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.inputfield('quota','text',6,FALSE,FALSE,_calculate_size($settings['quota'])).'</td>'."\n";
		echo '        </tr>'."\n".'<tr>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.$titanium_lang_new[$titanium_module_name]['IMAGE_MAX'].'</td>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.inputfield('max_upload','text',6,FALSE,FALSE,_calculate_size($settings['max_upload'])).'</td>'."\n";
		echo '        </tr>'."\n".'<tr>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.$titanium_lang_new[$titanium_module_name]['SPACING'].'</td>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.selectbox('spacing',$settings['spacing'],array('0' => $titanium_lang_new[$titanium_module_name]['SPACING_NONE'], '1' => '1px', '2' => '2px')).'</td>'."\n";
		echo '        </tr>'."\n".'<tr>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.$titanium_lang_new[$titanium_module_name]['PERPAGE_IMAGES'].'</td>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.selectbox_range('perpage',$settings['perpage'],'1','51','1').'</td>'."\n";
		echo '        </tr>'."\n".'<tr>'."\n";
		echo '	        <td'.tablecss('50%',FALSE,'row1').'>'.$titanium_lang_new[$titanium_module_name]['PERPAGE_USERS'].'</td>'."\n";
...
//-------------------------------------------------------------------------
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catBottom',3).'>'.submitbuttoncss(FALSE,$titanium_lang_new[$titanium_module_name]['SAVE_SETTINGS']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '</table>'."\n";
...
//-------------------------------------------------------------------------	
	...
	echo '	<tr>'."\n";
	echo '    <td'.tablecss('20%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['QUOTA']).'</td>'."\n";
	echo '    <td'.tablecss('20%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['QUOTA_USED']).'</td>'."\n";
	echo '    <td'.tablecss('60%',FALSE,'catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['QUOTA_PROGRESS']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr'.(($quotainfo['total_size'] == 0) ? '' : ' style="display:none;"').'>'."\n";
	echo '	  <td'.tablecss(FALSE,'center','row1',3).'>'.$titanium_lang_new[$titanium_module_name]['IMAGE_NONE'].'</td>'."\n";
	echo '  </tr>'."\n".'<tr'.(($quotainfo['total_size'] > 0) ? '' : ' style="display:none;"').'>'."\n";
...
//-------------------------------------------------------------------------
	if($_POST['quota'])
	{
		...
		_redirect_titanium('modules.php?name='.$titanium_module_name.'&op=users'.(($_POST['page']) ? '&page='.$_POST['page'] : ''));
	}
//-------------------------------------------------------------------------
//	LETS UPDATE THE SELECTED USERS QUOTA.
//-------------------------------------------------------------------------	
	...
	echo '<table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline">'."\n";	
	echo '	<tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catBottom',5).'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['USERS']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '	  <td'.tablecss(FALSE,'center','row1',5).'>'.(($titanium_db->sql_numrows($result) > 0) ? _alphabetlist() : $titanium_lang_new[$titanium_module_name]['USER_NONE']).'</td>'."\n";
	echo '  </tr>'."\n".'<tr '.(($titanium_db->sql_numrows($result) > 0) ? '' : 'style="display:none;"').'>'."\n";
	echo '	  <td'.tablecss('20%',FALSE,'catBottom').'>'.$titanium_lang_new[$titanium_module_name]['USER'].'</td>'."\n";
	echo '	  <td'.tablecss('20%',FALSE,'catBottom').'>'.$titanium_lang_new[$titanium_module_name]['IMAGECOUNT'].'</td>'."\n";
	echo '	  <td'.tablecss('20%',FALSE,'catBottom').'>'.$titanium_lang_new[$titanium_module_name]['QUOTA_USED'].'</td>'."\n";
	echo '	  <td'.tablecss('20%',FALSE,'catBottom').'>'.$titanium_lang_new[$titanium_module_name]['QUOTA_LEFT'].'</td>'."\n";
	echo '	  <td'.tablecss('20%','center','catBottom').'>'.$titanium_lang_new[$titanium_module_name]['OPTIONS'].'</td>'."\n";
	echo '  </tr>'."\n";
	$i = 0;
	while($row = $titanium_db->sql_fetchrow($result))
	{
		...
		if($row['uid'] > 1)
		{
			...
			echo '	  <td'.tablecss('20%',FALSE,'row1').'>'.(($image_count == 0) ? $titanium_lang_new[$titanium_module_name]['IMAGECOUNT_ZERO'] : sprintf($titanium_lang_new[$titanium_module_name]['IMAGECOUNT_TOTAL'], $row['uid'], $image_count)).'</td>'."\n";
			echo '	  <td'.tablecss('20%',FALSE,'row1').'>'._calculate_size($quotainfo['total_size']).'</td>'."\n";
			echo '	  <td'.tablecss('20%',FALSE,'row1').'><form action="modules.php?name='.$titanium_module_name.'&amp;op=users&amp;uid='.$row['uid'].'" method="post">'.inputfield('page','hidden',FALSE,FALSE,FALSE,$_GET['page']).inputfield('uid','hidden',FALSE,FALSE,FALSE,$row['uid']).'&nbsp;'.inputfield('quota','text',10,FALSE,FALSE,_calculate_size($row['quota'])).'&nbsp;'.submitbuttoncss(FALSE,$titanium_lang_new[$titanium_module_name]['SAVE']).'</form></td>'."\n";
			echo '	  <td'.tablecss('20%','center','row1').'><a'.linkcss().' data-id="'.$row['uid'].'" class="delete-user" href="">'.$titanium_lang_new[$titanium_module_name]['DELETE'].'</a></td>'."\n";
			echo '  </tr>'."\n";
		}
	}
	$titanium_db->sql_freeresult($result);
...
//-------------------------------------------------------------------------
	if($total > $settings['admin_perpage'])
	{
		if ($pagination->getCurrent() == 1)
			...
			$first = ' | <a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;op=users&amp;page='.$pagination->getFirst().'">'.$titanium_lang_new[$titanium_module_name]['FIRST'].'</a> |';
			
		if ($pagination->getPrevious())
			$prev = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;op=users&amp;page='.$pagination->getPrevious().'">'.$titanium_lang_new[$titanium_module_name]['PREVIOUS'].'</a> | ';
		else
			$prev = $titanium_lang_new[$titanium_module_name]['PREVIOUS'].' | ';
			
		if ($pagination->getNext())
			$next = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;op=users&amp;page='.$pagination->getNext().'">'.$titanium_lang_new[$titanium_module_name]['NEXT'].'</a> | ';
		else
			$next = $titanium_lang_new[$titanium_module_name]['NEXT'].' | ';
			
		if ($pagination->getLast())
			$last = '<a'.linkcss().' href="modules.php?name='.$titanium_module_name.'&amp;op=users&amp;page='.$pagination->getLast().'">'.$titanium_lang_new[$titanium_module_name]['LAST'].'</a>';
		else
			$last = $titanium_lang_new[$titanium_module_name]['LAST'];
			
		echo $pagination->getFirstOf().' '.$titanium_lang_new[$titanium_module_name]['TO'].' '.$pagination->getSecondOf().' '.$titanium_lang_new[$titanium_module_name]['OF'].' '.$pagination->getTotalItems().' '.$first . " " . $prev . " " . $next . " " . $last;
	}
	else
	{
		echo '&nbsp;';
...
//-------------------------------------------------------------------------	
	...
	echo '<table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline">'."\n";
	echo '  <tr>';
	echo '    <td'.tablecss(FALSE,'center','catHead',5).'>'._string_to_upper(sprintf($titanium_lang_new[$titanium_module_name]['IMAGES_SUBMITTED'],_submitter($_GET['uid']))).'</td>';
	echo '  </tr>';
	echo '  <tr>';
	echo '    <td'.tablecss('20%','center','catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['IMAGE']).'</td>';
	echo '    <td'.tablecss('20%','center','catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['UPLOADED']).'</td>';
	echo '    <td'.tablecss('20%','center','catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['RESOLUTION']).'</td>';
	echo '    <td'.tablecss('20%','center','catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['IMAGE_SIZE']).'</td>';
	echo '    <td'.tablecss('20%','center','catHead').'>'._string_to_upper($titanium_lang_new[$titanium_module_name]['OPTIONS']).'</td>';
	echo '  </tr>';
	while($uploadinfo = $titanium_db->sql_fetchrow($result))
	{
		echo '  <tr id="user-image-'.$uploadinfo['pid'].'">';
		echo '    <td'.tablecss('20%','center','row1').'><a'.linkcss().get_image_viewer().' href="'._IREPOSITORY_DIR.'/'.($uploadinfo['submitter']+10000).'/'.$uploadinfo['filename'].'">'.$titanium_lang_new[$titanium_module_name]['VIEW'].'</a></td>';
		...
		echo '    <td'.tablecss('20%','center','row1').'><a'.linkcss().' data-id="'.$uploadinfo['pid'].':::'.$uploadinfo['submitter'].'" class="delete-user-image" href="javascript:void(0);">'.$titanium_lang_new[$titanium_module_name]['DELETE'].'</a></td>';
		echo '  </tr>';
	}
	echo '  <tr>';
...
//-------------------------------------------------------------------------
	...
	switch(strtolower($image_size_info['mime']))
	{
		...
		case 'image/pjpeg':
			break;
		default:
			die(json_encode(array('error' => $titanium_lang_new[$titanium_module_name]['IMAGE_ALLOWED'])));
	}
//-------------------------------------------------------------------------
//	DO A QUICK CHECK TO MAKE SURE THE FILE BE UPLOADED IS AN IMAGE.
//-------------------------------------------------------------------------
...
if(!is_user())
{
	...
	echo '<table style="width:100%;" border="0" cellpadding="4" cellspacing="1" class="forumline">'."\n";
	echo '  <tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catHead',2).'>'.$titanium_lang_new[$titanium_module_name]['ATTENTION'].'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','row1',2).'>'.$titanium_lang_new[$titanium_module_name]['ANONYMOUS'].'</td>'."\n";
	echo '  </tr>'."\n".'<tr>'."\n";
	echo '    <td'.tablecss(FALSE,'center','catBottom',2).'>&nbsp;</td>'."\n";
	echo '  </tr>'."\n";
	echo '</table>'."\n";
