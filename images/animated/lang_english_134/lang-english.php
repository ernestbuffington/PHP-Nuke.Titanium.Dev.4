...
define_once('_GAINACCESS',' group to gain access!');
define_once('_MUSTJOIN','You must join the ');
define_once('_CREDENTIALS','You do not have the necessary credentials<br />to access the ');
define_once('_AREA','Area!');
# Modules group mod v1.0 END
define_once('_EMPTY_MESSAGE','You must enter a message first');
define_once('_YOUHAVE_1_MSGS','You Have <strong><span class="blink-one">%s</span></strong> New Private Message');
define_once('_YOUHAVE_X_MSGS','You Have <strong><span class="blink-one">%s</span></strong> New Private Messages');
define_once('_YOUHAVE_NO_MSGS','You Have <strong><span class="blink-one">0</span></strong> NEW Messages, Nobody Likes You!');
// new common language define_onces.
...
define_once('_ASSOCIATED_BLOG_TOPICS', 'Associated Blog Topics');
...
define_once("_NICKNAME","Nickname/Callsign");
...
define_once("_MOREBLOGS","More in Blogs Section");
...
define_once("_BLOG_SUBMISSIONS","Submissions");
