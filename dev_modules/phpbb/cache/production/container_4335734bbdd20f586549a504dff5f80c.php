...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbbNuke_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'phpbbNuke_forums', 'phpbbNuke_posts', 'phpbbNuke_topics', 'phpbbNuke_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbbNuke_captcha_questions', 'phpbbNuke_captcha_answers', 'phpbbNuke_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbbNuke_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, 'phpbbNuke_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbNuke_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpbbNuke_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_bbcodes', 'phpbbNuke_smilies', 'phpbbNuke_styles', 'phpbbNuke_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbNuke_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbNuke_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbbNuke_acl_groups',
            'tables.acl_options' => 'phpbbNuke_acl_options',
            'tables.acl_roles' => 'phpbbNuke_acl_roles',
            'tables.acl_roles_data' => 'phpbbNuke_acl_roles_data',
            'tables.acl_users' => 'phpbbNuke_acl_users',
            'tables.attachments' => 'phpbbNuke_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbbNuke_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbbNuke_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbbNuke_oauth_accounts',
            'tables.banlist' => 'phpbbNuke_banlist',
            'tables.bbcodes' => 'phpbbNuke_bbcodes',
            'tables.bookmarks' => 'phpbbNuke_bookmarks',
            'tables.bots' => 'phpbbNuke_bots',
            'tables.captcha_qa_questions' => 'phpbbNuke_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbbNuke_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbbNuke_qa_confirm',
            'tables.config' => 'phpbbNuke_config',
            'tables.config_text' => 'phpbbNuke_config_text',
            'tables.confirm' => 'phpbbNuke_confirm',
            'tables.disallow' => 'phpbbNuke_disallow',
            'tables.drafts' => 'phpbbNuke_drafts',
            'tables.ext' => 'phpbbNuke_ext',
            'tables.extensions' => 'phpbbNuke_extensions',
            'tables.extension_groups' => 'phpbbNuke_extension_groups',
            'tables.forums' => 'phpbbNuke_forums',
            'tables.forums_access' => 'phpbbNuke_forums_access',
            'tables.forums_track' => 'phpbbNuke_forums_track',
            'tables.forums_watch' => 'phpbbNuke_forums_watch',
            'tables.groups' => 'phpbbNuke_groups',
            'tables.icons' => 'phpbbNuke_icons',
            'tables.lang' => 'phpbbNuke_lang',
            'tables.log' => 'phpbbNuke_log',
            'tables.login_attempts' => 'phpbbNuke_login_attempts',
            'tables.migrations' => 'phpbbNuke_migrations',
            'tables.moderator_cache' => 'phpbbNuke_moderator_cache',
            'tables.modules' => 'phpbbNuke_modules',
            'tables.notification_emails' => 'phpbbNuke_notification_emails',
            'tables.notification_types' => 'phpbbNuke_notification_types',
            'tables.notifications' => 'phpbbNuke_notifications',
            'tables.poll_options' => 'phpbbNuke_poll_options',
            'tables.poll_votes' => 'phpbbNuke_poll_votes',
            'tables.posts' => 'phpbbNuke_posts',
            'tables.privmsgs' => 'phpbbNuke_privmsgs',
            'tables.privmsgs_folder' => 'phpbbNuke_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbbNuke_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbbNuke_privmsgs_to',
            'tables.profile_fields' => 'phpbbNuke_profile_fields',
            'tables.profile_fields_data' => 'phpbbNuke_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbbNuke_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbbNuke_profile_lang',
            'tables.ranks' => 'phpbbNuke_ranks',
            'tables.reports' => 'phpbbNuke_reports',
            'tables.reports_reasons' => 'phpbbNuke_reports_reasons',
            'tables.search_results' => 'phpbbNuke_search_results',
            'tables.search_wordlist' => 'phpbbNuke_search_wordlist',
            'tables.search_wordmatch' => 'phpbbNuke_search_wordmatch',
            'tables.sessions' => 'phpbbNuke_sessions',
            'tables.sessions_keys' => 'phpbbNuke_sessions_keys',
            'tables.sitelist' => 'phpbbNuke_sitelist',
            'tables.smilies' => 'phpbbNuke_smilies',
            'tables.sphinx' => 'phpbbNuke_sphinx',
            'tables.styles' => 'phpbbNuke_styles',
            'tables.styles_template' => 'phpbbNuke_styles_template',
            'tables.styles_template_data' => 'phpbbNuke_styles_template_data',
            'tables.styles_theme' => 'phpbbNuke_styles_theme',
            'tables.styles_imageset' => 'phpbbNuke_styles_imageset',
            'tables.styles_imageset_data' => 'phpbbNuke_styles_imageset_data',
            'tables.teampage' => 'phpbbNuke_teampage',
            'tables.topics' => 'phpbbNuke_topics',
            'tables.topics_posted' => 'phpbbNuke_topics_posted',
            'tables.topics_track' => 'phpbbNuke_topics_track',
            'tables.topics_watch' => 'phpbbNuke_topics_watch',
            'tables.user_group' => 'phpbbNuke_user_group',
            'tables.user_notifications' => 'phpbbNuke_user_notifications',
            'tables.users' => 'phpbbNuke_users',
            'tables.warnings' => 'phpbbNuke_warnings',
            'tables.words' => 'phpbbNuke_words',
            'tables.zebra' => 'phpbbNuke_zebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbbNuke_acl_groups',
                'acl_options' => 'phpbbNuke_acl_options',
                'acl_roles' => 'phpbbNuke_acl_roles',
                'acl_roles_data' => 'phpbbNuke_acl_roles_data',
                'acl_users' => 'phpbbNuke_acl_users',
                'attachments' => 'phpbbNuke_attachments',
                'auth_provider_oauth_token_storage' => 'phpbbNuke_oauth_tokens',
                'auth_provider_oauth_states' => 'phpbbNuke_oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbbNuke_oauth_accounts',
                'banlist' => 'phpbbNuke_banlist',
                'bbcodes' => 'phpbbNuke_bbcodes',
                'bookmarks' => 'phpbbNuke_bookmarks',
                'bots' => 'phpbbNuke_bots',
                'captcha_qa_questions' => 'phpbbNuke_captcha_questions',
                'captcha_qa_answers' => 'phpbbNuke_captcha_answers',
                'captcha_qa_confirm' => 'phpbbNuke_qa_confirm',
                'config' => 'phpbbNuke_config',
                'config_text' => 'phpbbNuke_config_text',
                'confirm' => 'phpbbNuke_confirm',
                'disallow' => 'phpbbNuke_disallow',
                'drafts' => 'phpbbNuke_drafts',
                'ext' => 'phpbbNuke_ext',
                'extensions' => 'phpbbNuke_extensions',
                'extension_groups' => 'phpbbNuke_extension_groups',
                'forums' => 'phpbbNuke_forums',
                'forums_access' => 'phpbbNuke_forums_access',
                'forums_track' => 'phpbbNuke_forums_track',
                'forums_watch' => 'phpbbNuke_forums_watch',
                'groups' => 'phpbbNuke_groups',
                'icons' => 'phpbbNuke_icons',
                'lang' => 'phpbbNuke_lang',
                'log' => 'phpbbNuke_log',
                'login_attempts' => 'phpbbNuke_login_attempts',
                'migrations' => 'phpbbNuke_migrations',
                'moderator_cache' => 'phpbbNuke_moderator_cache',
                'modules' => 'phpbbNuke_modules',
                'notification_emails' => 'phpbbNuke_notification_emails',
                'notification_types' => 'phpbbNuke_notification_types',
                'notifications' => 'phpbbNuke_notifications',
                'poll_options' => 'phpbbNuke_poll_options',
                'poll_votes' => 'phpbbNuke_poll_votes',
                'posts' => 'phpbbNuke_posts',
                'privmsgs' => 'phpbbNuke_privmsgs',
                'privmsgs_folder' => 'phpbbNuke_privmsgs_folder',
                'privmsgs_rules' => 'phpbbNuke_privmsgs_rules',
                'privmsgs_to' => 'phpbbNuke_privmsgs_to',
                'profile_fields' => 'phpbbNuke_profile_fields',
                'profile_fields_data' => 'phpbbNuke_profile_fields_data',
                'profile_fields_options_language' => 'phpbbNuke_profile_fields_lang',
                'profile_fields_language' => 'phpbbNuke_profile_lang',
                'ranks' => 'phpbbNuke_ranks',
                'reports' => 'phpbbNuke_reports',
                'reports_reasons' => 'phpbbNuke_reports_reasons',
                'search_results' => 'phpbbNuke_search_results',
                'search_wordlist' => 'phpbbNuke_search_wordlist',
                'search_wordmatch' => 'phpbbNuke_search_wordmatch',
                'sessions' => 'phpbbNuke_sessions',
                'sessions_keys' => 'phpbbNuke_sessions_keys',
                'sitelist' => 'phpbbNuke_sitelist',
                'smilies' => 'phpbbNuke_smilies',
                'sphinx' => 'phpbbNuke_sphinx',
                'styles' => 'phpbbNuke_styles',
                'styles_template' => 'phpbbNuke_styles_template',
                'styles_template_data' => 'phpbbNuke_styles_template_data',
                'styles_theme' => 'phpbbNuke_styles_theme',
                'styles_imageset' => 'phpbbNuke_styles_imageset',
                'styles_imageset_data' => 'phpbbNuke_styles_imageset_data',
                'teampage' => 'phpbbNuke_teampage',
                'topics' => 'phpbbNuke_topics',
                'topics_posted' => 'phpbbNuke_topics_posted',
                'topics_track' => 'phpbbNuke_topics_track',
                'topics_watch' => 'phpbbNuke_topics_watch',
                'user_group' => 'phpbbNuke_user_group',
                'user_notifications' => 'phpbbNuke_user_notifications',
                'users' => 'phpbbNuke_users',
                'warnings' => 'phpbbNuke_warnings',
                'words' => 'phpbbNuke_words',
                'zebra' => 'phpbbNuke_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbbNuke_',
