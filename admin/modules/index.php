...
function adminMain() {
    global $language, $admin, $aid, $pnt_prefix, $file, $pnt_db, $sitename, $pnt_user_prefix, $admin_file, $bgcolor1, $pnt_config, $admdata, $pnt_dbtype, $cache, $json, $admincookie, $radminsuper;
/*****[BEGIN]******************************************
