...
$totalselected = $titanium_db->sql_numrows($titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges`"));
if($totalselected > 0) {
  ...
  echo '</tr>'."\n";
  $result = $titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges` ORDER BY $column $direction LIMIT $min,$perpage");
