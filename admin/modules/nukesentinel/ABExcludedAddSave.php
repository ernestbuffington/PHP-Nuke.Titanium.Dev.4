...
$test1 = $titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_lo' AND `ip_hi`>='$longip_lo'");
$test2 = $titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_hi' AND `ip_hi`>='$longip_hi'");
$test3 = $titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges` WHERE `ip_lo`>='$longip_lo' AND `ip_hi`<='$longip_hi'");
$test4 = $titanium_db->sql_query("SELECT * FROM `".$titanium_prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_lo' AND `ip_hi`>='$longip_hi'");
...
if($testnum1 > 0 OR $testnum2 >0 OR $testnum3 >0 OR $testnum4 >0) {
  ...
  $xtime = time();
  $titanium_db->sql_query("INSERT INTO `".$titanium_prefix."_nsnst_excluded_ranges` VALUES ('$longip_lo', '$longip_hi', '$xtime', '$xnotes', '$xc2c')");
  if($another == 1) {
