...
global $pnt_censor_words, $pnt_censor, $admLang;
$pnt_censor_words = str_replace(" ", "\n", $pnt_censor_words);
echo '  <tr>'.PHP_EOL;
...
echo '          <td class="row1" style="width: 50%;"><textarea name="xcensor_words" cols="40" rows="8" style="min-height:100px;">'.$pnt_censor_words.'</textarea></td>'.PHP_EOL;
echo '        </tr>'.PHP_EOL;
echo '        <tr>'.PHP_EOL;
echo '          <td class="row1" style="width: 50%;">'.$admlang['censor']['settings'].'</td>'.PHP_EOL;
echo '          <td class="row1" style="width: 50%;">'.select_box('xcensor',$pnt_censor,array(0 => $admlang['censor']['off'], 1 => $admlang['censor']['whole'], 2 => $admlang['censor']['partial'])).'</td>'.PHP_EOL;
echo '        </tr>'.PHP_EOL;
echo '      </table>'.PHP_EOL;
