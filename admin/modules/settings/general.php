...
global $sitename, $nukeurl, $site_logo, $slogan, $startdate, $adminmail, $top, $bloghome, $oldnum, $ultramode, $anonpost, $language, $locale, $admlang;
echo '  <tr>'.PHP_EOL;
...
echo '          <td class="row1" style="width: 50%;"><input type="text" name="xstoryhome" value="'.$bloghome.'" maxlength="255" style="width: 100px;" /></td>'.PHP_EOL;
echo '        </tr>'.PHP_EOL;
echo '        <tr>'.PHP_EOL;
