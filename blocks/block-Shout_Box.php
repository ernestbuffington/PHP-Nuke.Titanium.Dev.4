...
global $titanium_prefix, $ShoutSubmit, $ShoutComment, $titanium_db, $titanium_user, $cookie, $shoutuid, $top_content, $mid_content, $bottom_content, $ShoutMarqueewidth, $ShoutMarqueeheight, $currentlang;
