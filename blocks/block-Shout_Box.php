...
global $pnt_prefix, $ShoutSubmit, $ShoutComment, $pnt_db, $pnt_user, $cookie, $shoutuid, $top_content, $mid_content, $bottom_content, $ShoutMarqueewidth, $ShoutMarqueeheight, $currentlang;
